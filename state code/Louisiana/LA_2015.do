...
use "${path}/NCES/School/NCES_2014_School.dta"
...
use "${path}/NCES/District/NCES_2014_District.dta"
...
import excel "${path}/Original Data Files/LA_OriginalData_2015_all.xlsx", sheet("Sheet1") cellrange(A4:AA52333) firstrow clear
