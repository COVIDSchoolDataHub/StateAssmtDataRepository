...
save "${path}/Semi-Processed Data Files/TN_2022_nogroup.dta", replace
...
save "${path}/Semi-Processed Data Files/TN_2022_group.dta", replace
clear
use "${path}/Semi-Processed Data Files/TN_2022_nogroup.dta"
merge m:1 DataLevel StateAssignedDistID StateAssignedSchID Subject GradeLevel using "${path}/Semi-Processed Data Files/TN_2022_group.dta"
drop _merge
replace StudentGroup_TotalTested="--" if StudentGroup_TotalTested == ""
save "${path}/Semi-Processed Data Files/TN_2022_all.dta", replace
