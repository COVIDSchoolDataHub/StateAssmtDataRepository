...
drop Charter SchoolLevel SchoolType
...
import excel "${path}/Original Data Files/LA_OriginalData_2021_all.xlsx", sheet("Grades 3-8") cellrange(A4:AA57482) firstrow clear
...
tostring StateAbbrev, replace force
