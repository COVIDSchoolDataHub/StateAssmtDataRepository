...
import excel "${path}/Original Data Files/LA_OriginalData_2017_all.xlsx", sheet("Sheet1") cellrange(A4:AB104263) firstrow clear
...
rename T Lev4_percentsci
rename U Lev3_percentsci
rename V Lev2_percentsci
rename W Lev1_percentsci
rename SocialStudies Lev5_percentsoc
rename Y Lev4_percentsoc
rename Z Lev3_percentsoc
rename AA Lev2_percentsoc
rename AB Lev1_percentsoc
generate id = _n
