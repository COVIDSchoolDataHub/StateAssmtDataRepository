...
global yrfiles "/Users/hayden/Desktop/Research/VA/2006"
...
drop if schoolyear != "2005-2006"

gen StudentGroup = "All students"
gen StudentSubGroup = "All students"

save "${yrfiles}/VA_2006_base.dta", replace



////	Import disaggregate gender data

import delimited "/${yrfiles}/VA_OriginalData_2006_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${yrfiles}/VA_2006_gender.dta", replace



////	Import disaggregate language proficiency data

import delimited "/${yrfiles}/VA_OriginalData_2006_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL status"

save "${yrfiles}/VA_2006_language.dta", replace



////	Import disaggregate race data

import delimited "/${yrfiles}/VA_OriginalData_2006_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "Race"

save "${yrfiles}/VA_2006_race.dta", replace



////	Append aggregate and disaggregate 

use "${yrfiles}/VA_2006_base.dta", clear

append using "${yrfiles}/VA_2006_gender.dta"
append using "${yrfiles}/VA_2006_language.dta"
append using "${yrfiles}/VA_2006_race.dta"
...
use "${nces}/NCES_2005_District.dta", clear


keep if state_fips==51
drop if district_agency_type==.

save "${yrfiles}/VA_2005_nces_districts.dta", replace
...
merge m:1 state_leaid using "${yrfiles}/VA_2005_nces_districts.dta"
...
use "/${nces}/NCES_2005_School.dta", clear

keep if state_fips==51
drop if seasch==""

save "${yrfiles}/VA_2005_nces_schools.dta", replace
...
merge m:1 seasch using "/${yrfiles}/VA_2005_nces_schools.dta"
...
save "${yrfiles}/VA_2006_studentgrouptotals.dta", replace


use "${yrfiles}/VA_2006_base.dta", replace

merge m:1 NCESDistrictID NCESSchoolID intGrade intSubject intStudentGroup using "${yrfiles}/VA_2006_studentgrouptotals.dta"
...
export delimited using "${output}/VA_AssmtData_2006.csv", replace
