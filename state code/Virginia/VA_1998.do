...
global yrfiles "/Users/hayden/Desktop/Research/VA/1998"
...
save "/${yrfiles}/VA_1998_base.dta", replace
...
drop E F G H I J K L
rename Female gender1
rename Male gender2
...
save "/${yrfiles}/VA_1998_gender.dta", replace
...
rename B ProficientOrAbove_percent1	//Eng
rename G ProficientOrAbove_percent2	//math
rename L ProficientOrAbove_percent3	//Hist
rename Q ProficientOrAbove_percent4	//Sci
...
save "/${yrfiles}/VA_1998_race3.dta", replace
...
rename A StudentSubGroup
rename B ProficientOrAbove_percent1	//Eng
rename G ProficientOrAbove_percent2	//wri
rename L ProficientOrAbove_percent3	//mat
rename Q ProficientOrAbove_percent4	//soc
rename V ProficientOrAbove_percent5	//sci
rename AA ProficientOrAbove_percent6	//stem
...
save "/${yrfiles}/VA_1998_race58.dta", replace


////	APPEND AGGREGATE AND DISAGGREGATE DATA

use "/${yrfiles}/VA_1998_base.dta", clear

append using "/${yrfiles}/VA_1998_gender.dta"
append using "/${yrfiles}/VA_1998_race3.dta"
append using "/${yrfiles}/VA_1998_race58.dta"
...
save "/${yrfiles}/VA_1998_all.dta", replace
...
use "/${yrfiles}/VA_1998_all.dta", clear
...
export delimited using "${output}/VA_AssmtData_1998.csv", replace
