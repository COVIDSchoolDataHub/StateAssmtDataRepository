...
global yrfiles "/Users/hayden/Desktop/Research/VA/1999"
...
save "/${yrfiles}/VA_1999_base.dta", replace
...
save "/${yrfiles}/VA_1999_gender.dta", replace
...
rename C ProficientOrAbove_percent1	//Eng
rename H ProficientOrAbove_percent2	//math
rename M ProficientOrAbove_percent3	//Hist
rename R ProficientOrAbove_percent4	//Sci
...
save "/${yrfiles}/VA_1999_race3.dta", replace
...
rename A StudentSubGroup
rename C ProficientOrAbove_percent1	//Eng
rename H ProficientOrAbove_percent2	//wri
rename M ProficientOrAbove_percent3	//mat
rename R ProficientOrAbove_percent4	//soc
rename W ProficientOrAbove_percent5	//sci
rename AB ProficientOrAbove_percent6	//stem
...
save "/${yrfiles}/VA_1999_race58.dta", replace


////	APPEND AGGREGATE AND DISAGGREGATE DATA

use "/${yrfiles}/VA_1999_base.dta", clear

append using "/${yrfiles}/VA_1999_gender.dta"
append using "/${yrfiles}/VA_1999_race3.dta"
append using "/${yrfiles}/VA_1999_race58.dta"
...
save "/${yrfiles}/VA_1999_all.dta", replace
...
use "/${yrfiles}/VA_1999_all.dta", clear
...
export delimited using "${output}/VA_AssmtData_1999.csv", replace
