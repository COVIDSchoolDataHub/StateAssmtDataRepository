...
global yrfiles "/Users/hayden/Desktop/Research/VA/2004"
...
save "/${yrfiles}/VA_2004_base.dta", replace
...
save "/${yrfiles}/VA_2004_G03.dta", replace
...
save "/${yrfiles}/VA_2004_G05.dta", replace
...
save "/${yrfiles}/VA_2004_G08.dta", replace



//	Append aggregate and subgroup data together

use "/${yrfiles}/VA_2004_base.dta", clear

destring Pass Proficient Advanced, replace

append using "/${yrfiles}/VA_2004_G03.dta"
append using "/${yrfiles}/VA_2004_G05.dta"
append using "/${yrfiles}/VA_2004_G08.dta"
...
save "/${yrfiles}/VA_2004_all.dta", replace


		// Prepare dist data
		
use "/${nces}/NCES_2003_District.dta", clear

drop if state_fips!=51

save "/${yrfiles}/VA_2003_NCESDistricts.dta", replace

		// Prepare school data
		
use "/${nces}/NCES_2003_School.dta", clear

drop if state_fips!=51

save "/${yrfiles}/VA_2003_NCESSchools.dta", replace


use "/${yrfiles}/VA_2004_all.dta", clear

merge m:1 state_leaid using "/${yrfiles}/VA_2003_NCESDistricts.dta"
drop if _merge==2
...
merge m:1 seasch using "/${yrfiles}/VA_2003_NCESSchools.dta"
drop if _merge==2
