...
global yrfiles "/Users/hayden/Desktop/Research/VA/2021"
...
drop if schoolyear != "2020-2021"

gen StudentGroup = "All students"
gen StudentSubGroup = "All students"

save "${yrfiles}/VA_2021_base.dta", replace



////	Import disaggregate gender data

import delimited "/${yrfiles}/VA_OriginalData_2021_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${yrfiles}/VA_2021_gender.dta", replace



////	Import disaggregate language proficiency data

import delimited "/${yrfiles}/VA_OriginalData_2021_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL status"

save "${yrfiles}/VA_2021_language.dta", replace



////	Import disaggregate race data

import delimited "/${yrfiles}/VA_OriginalData_2021_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "Race"

save "${yrfiles}/VA_2021_race.dta", replace



////	Append aggregate and disaggregate 

use "${yrfiles}/VA_2021_base.dta", clear

append using "${yrfiles}/VA_2021_gender.dta"
append using "${yrfiles}/VA_2021_language.dta"
append using "${yrfiles}/VA_2021_race.dta"
...
save "${yrfiles}/VA_2020_nces_districts.dta", replace
...
merge m:1 state_leaid using "${yrfiles}/VA_2020_nces_districts.dta"
...
save "${yrfiles}/VA_2020_nces_schools.dta", replace
...
merge m:1 seasch using "/${yrfiles}/VA_2020_nces_schools.dta"

drop if _merge==2

replace DistCharter="Yes" if seasch=="123-1233119"
replace DistCharter="Yes" if seasch=="002-0020890"
replace DistCharter="Yes" if seasch=="053-0531200"
...
save "${yrfiles}/VA_2021_studentgrouptotals.dta", replace


// Flag

use "${yrfiles}/VA_2021_base.dta", replace


// Flag

merge m:1 NCESDistrictID NCESSchoolID intGrade intSubject intStudentGroup using "${yrfiles}/VA_2021_studentgrouptotals.dta"
...
export delimited using "${output}/VA_AssmtData_2021.csv", replace
