...
global yrfiles "/Users/hayden/Desktop/Research/VA/2002"
...
save "/${yrfiles}/VA_2002_base.dta", replace
...
save "/${yrfiles}/VA_2002_gender.dta", replace
...
rename F ProficientOrAbove_percent1	//Eng
rename K ProficientOrAbove_percent2	//math
rename P ProficientOrAbove_percent3	//Hist
rename U ProficientOrAbove_percent4	//Sci
...
save "/${yrfiles}/VA_2002_race3.dta", replace
...
rename A StudentSubGroup
rename F ProficientOrAbove_percent1	//Eng
rename K ProficientOrAbove_percent2	//wri
rename P ProficientOrAbove_percent3	//mat
rename U ProficientOrAbove_percent4	//soc
rename Z ProficientOrAbove_percent5	//sci
rename AE ProficientOrAbove_percent6	//stem
...
save "/${yrfiles}/VA_2002_race58.dta", replace
...
save "/${yrfiles}/VA_2002_elstatus.dta", replace



////	APPEND AGGREGATE AND DISAGGREGATE DATA

use "/${yrfiles}/VA_2002_base.dta", clear

append using "/${yrfiles}/VA_2002_gender.dta"
append using "/${yrfiles}/VA_2002_race3.dta"
append using "/${yrfiles}/VA_2002_race58.dta"
append using "/${yrfiles}/VA_2002_elstatus.dta"
...
save "/${yrfiles}/VA_2002_all.dta", replace
...
use "/${yrfiles}/VA_2002_all.dta", clear
...
export delimited using "${output}/VA_AssmtData_2002.csv", replace
