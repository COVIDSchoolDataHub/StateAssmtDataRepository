...
global yrfiles "/Users/hayden/Desktop/Research/VA/2017"
...
save "${yrfiles}/VA_2017_base.dta", replace



////	Import disaggregate gender data

import delimited "/${yrfiles}/VA_OriginalData_2017_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${yrfiles}/VA_2017_gender.dta", replace



////	Import disaggregate language proficiency data

import delimited "/${yrfiles}/VA_OriginalData_2017_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL status"

save "${yrfiles}/VA_2017_language.dta", replace



////	Import disaggregate race data

import delimited "/${yrfiles}/VA_OriginalData_2017_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "Race"

save "${yrfiles}/VA_2017_race.dta", replace



////	Append aggregate and disaggregate 

use "${yrfiles}/VA_2017_base.dta", clear

append using "${yrfiles}/VA_2017_gender.dta"
append using "${yrfiles}/VA_2017_language.dta"
append using "${yrfiles}/VA_2017_race.dta"
...
save "${yrfiles}/VA_2016_nces_districts.dta", replace
...
merge m:1 state_leaid using "${yrfiles}/VA_2016_nces_districts.dta"
...
save "${yrfiles}/VA_2016_nces_schools.dta", replace
...
merge m:1 seasch using "/${yrfiles}/VA_2016_nces_schools.dta"
...
save "${yrfiles}/VA_2017_studentgrouptotals.dta", replace


// Flag

use "${yrfiles}/VA_2017_base.dta", replace


// Flag

merge m:1 NCESDistrictID NCESSchoolID intGrade intSubject intStudentGroup using "${yrfiles}/VA_2017_studentgrouptotals.dta"
...
export delimited using "${output}/VA_AssmtData_2017.csv", replace
