...
global yrfiles "/Users/hayden/Desktop/Research/VA/2000"
...
save "/${yrfiles}/VA_2000_base.dta", replace
...
save "/${yrfiles}/VA_2000_gender.dta", replace
...
rename D ProficientOrAbove_percent1	//Eng
rename I ProficientOrAbove_percent2	//math
rename N ProficientOrAbove_percent3	//Hist
rename S ProficientOrAbove_percent4	//Sci
...
save "/${yrfiles}/VA_2000_race3.dta", replace
...
rename A StudentSubGroup
rename D ProficientOrAbove_percent1	//Eng
rename I ProficientOrAbove_percent2	//wri
rename N ProficientOrAbove_percent3	//mat
rename S ProficientOrAbove_percent4	//soc
rename X ProficientOrAbove_percent5	//sci
rename AC ProficientOrAbove_percent6	//stem
...
save "/${yrfiles}/VA_2000_race58.dta", replace
...
//	FLAG	//
drop E F G H
rename NonLEP elstatus1
rename LEP elstatus2
//
...
save "/${yrfiles}/VA_2000_elstatus.dta", replace


////	APPEND AGGREGATE AND DISAGGREGATE DATA

use "/${yrfiles}/VA_2000_base.dta", clear

append using "/${yrfiles}/VA_2000_gender.dta"
append using "/${yrfiles}/VA_2000_race3.dta"
append using "/${yrfiles}/VA_2000_race58.dta"
append using "/${yrfiles}/VA_2000_elstatus.dta"
...
save "/${yrfiles}/VA_2000_all.dta", replace
...
use "/${yrfiles}/VA_2000_all.dta", clear
...
replace StateAssignedSchID="" if (DataLevel!=2 & StateAssignedSchID==".")
replace seasch="" if (DataLevel!=2 & seasch==".")


export delimited using "${output}/VA_AssmtData_2000.csv", replace
