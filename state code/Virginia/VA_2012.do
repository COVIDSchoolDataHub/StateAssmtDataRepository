...
global yrfiles "/Users/hayden/Desktop/Research/VA/2012"
...
save "${yrfiles}/VA_2012_base.dta", replace



////	Import disaggregate gender data

import delimited "/${yrfiles}/VA_OriginalData_2012_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${yrfiles}/VA_2012_gender.dta", replace



////	Import disaggregate language proficiency data

import delimited "/${yrfiles}/VA_OriginalData_2012_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL status"

save "${yrfiles}/VA_2012_language.dta", replace



////	Import disaggregate race data

import delimited "/${yrfiles}/VA_OriginalData_2012_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "Race"

save "${yrfiles}/VA_2012_race.dta", replace



////	Append aggregate and disaggregate 

use "${yrfiles}/VA_2012_base.dta", clear

append using "${yrfiles}/VA_2012_gender.dta"
append using "${yrfiles}/VA_2012_language.dta"
append using "${yrfiles}/VA_2012_race.dta"
...
merge m:1 state_leaid using "${yrfiles}/VA_2011_nces_districts.dta"
...
save "${yrfiles}/VA_2011_nces_schools.dta", replace
...
merge m:1 seasch using "/${yrfiles}/VA_2011_nces_schools.dta"
...
save "${yrfiles}/VA_2012_studentgrouptotals.dta", replace


// Flag

use "${yrfiles}/VA_2012_base.dta", replace


// Flag

merge m:1 NCESDistrictID NCESSchoolID intGrade intSubject intStudentGroup using "${yrfiles}/VA_2012_studentgrouptotals.dta"
...
export delimited using "${output}/VA_AssmtData_2012.csv", replace
