...
merge m:1 State_leaid using "${NCES}/NCES_2015_District.dta", update

drop if _merge == 2
drop _merge

replace CountyName = "WAYNE COUNTY" if State_leaid == "82015"
replace CountyCode = 26163 if State_leaid == "82015"
