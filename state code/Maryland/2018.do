...
import delimited "${raw}/MD_OriginalData_2018_ela_mat.csv", varnames(1) delimit(",") case(preserve) clear
...
save "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta", replace
//Import Science Data
save "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta", replace


import delimited "${raw}/MCAP_SCIENCE_2018.csv", varnames(1) delimit(",") case(preserve) clear
drop CreateDate
...
append using "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta"
...
import delimited "${raw}/2018Participation.csv", varnames(1) delimit(",") case(preserve) clear
...
merge 1:m LSSNumber SchoolNumber Subject using  "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta",nogenerate
...
use "/Users/meganchen/Desktop/Research/Maryland/NCES_2017_School.dta", clear
...
merge 1:m seasch using "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta", keep(match using)
...
use "/Users/meganchen/Desktop/Research/Maryland/NCES_2017_District.dta", clear
...
merge 1:m State_leaid using "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta", keep(match using) nogenerate
...
rename StudentGroupName StudentGroup
rename LocalSchoolSystemNumber LSSNumber
//keep TotalParticipantPct Subject LSSNumber Year LocalSchoolSystemName SchoolNumber SchoolName
//tostring LSSNumber, force replace
...
merge 1:1 LSSNumber SchoolNumber Subject SchoolName  using "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta"
/*
save "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta", replace
...
append using "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta"
replace Subject = "sci" if Subject == "" & Lev1_percent == ""
...
merge 1:1 LSSNumber SchoolNumber Subject using "/Users/meganchen/Desktop/Research/MD_2018_AssmtDataTemp.dta", nogenerate
