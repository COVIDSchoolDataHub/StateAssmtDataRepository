...
merge m:1 SchName DistName StudentSubGroup GradeLevel Subject using "${int}/UT_2018_school.dta"
...
merge m:1 DistName StudentSubGroup GradeLevel Subject using "${int}/UT_2018_district.dta"
