...
use "${input}/WA_AssmtData_2018_all.dta", clear
...
save "${output}/WA_BIE_AssmtData_2018.dta", replace

export delimited using "${output}/csv/WA_BIE_AssmtData_2018.csv", replace
