...
global subject1 ELA Math

foreach a of local years {
	foreach b in $grade {
		foreach c in $subject1 {
...
local years3 2016 2017

foreach a of local years3 {
...
local years2 2019 2021 2022
global subject2 ELA MATH

foreach a of local years2 {
	foreach b in $grade {
