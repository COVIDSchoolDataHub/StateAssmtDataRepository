...
save "$data/ND_AssmtData_2019.dta", replace
...
save "$NCES/Cleaned NCES Data/NCES_2019_School_ND.dta", replace

use "$NCES/NCES District Files, Fall 1997-Fall 2021/NCES_2018_District.dta", clear
drop if state_location!= "ND"
gen StateAssignedDistID = substr(state_leaid, 4, 8)
save "$NCES/Cleaned NCES Data/NCES_2019_District_ND.dta", replace

//Merge Data
use "$data/ND_AssmtData_2019.dta", clear
merge m:1 StateAssignedDistID using "$NCES/Cleaned NCES Data/NCES_2019_District_ND.dta"
drop if _merge == 2

merge m:1 StateAssignedSchID StateAssignedDistID using "$NCES/Cleaned NCES Data/NCES_2019_School_ND.dta", gen (merge2)
drop if merge2 == 2
...
save "$data/ND_AssmtData_2019.dta", replace
export delimited "$data/ND_AssmtData_2019.csv", replace
clear
