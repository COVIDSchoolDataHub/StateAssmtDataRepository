...
save "$data/ND_AssmtData_2015.dta", replace
...
save "$NCES/Cleaned NCES Data/NCES_2015_School_ND.dta", replace

use "$NCES/NCES District Files, Fall 1997-Fall 2021/NCES_2014_District.dta", clear
drop if state_location!= "ND"
gen StateAssignedDistID = state_leaid
save "$NCES/Cleaned NCES Data/NCES_2015_District_ND.dta", replace

//Merge Data
use "$data/ND_AssmtData_2015.dta", clear
merge m:1 StateAssignedDistID using "$NCES/Cleaned NCES Data/NCES_2015_District_ND.dta"
drop if _merge == 2

merge m:1 StateAssignedSchID StateAssignedDistID using "$NCES/Cleaned NCES Data/NCES_2015_School_ND.dta", gen (merge2)
drop if merge2 == 2
...
merge 1:1 NCESDistrictID DistName NCESSchoolID SchName StudentSubGroup GradeLevel Subject using "$counts/ND_edfactscount2015.dta"
drop if _merge == 2
...
save "$data/ND_AssmtData_2015.dta", replace
export delimited "$data/ND_AssmtData_2015.csv", replace
clear
