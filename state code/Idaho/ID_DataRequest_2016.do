...
// 2015-2016
/*
import excel "$original_files/ID_OriginalData_2016.xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2016_state.dta", replace

import excel "$original_files/ID_OriginalData_2016.xlsx", sheet("Districts") firstrow clear
gen DataLevel = "District"
save "${temp_files}/ID_AssmtData_2016_district.dta", replace

import excel "$original_files/ID_OriginalData_2016.xlsx", sheet("Schools") firstrow clear
