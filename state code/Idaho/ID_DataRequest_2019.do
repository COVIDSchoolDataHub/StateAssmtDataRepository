...
// 2018-2019
/*
import excel "$original_files/ID_OriginalData_2019.xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2019_state.dta", replace

import excel "$original_files/ID_OriginalData_2019.xlsx", sheet("Districts") firstrow clear
gen DataLevel = "District"
save "${temp_files}/ID_AssmtData_2019_district.dta", replace

import excel "$original_files/ID_OriginalData_2019.xlsx", sheet("Schools") firstrow clear
