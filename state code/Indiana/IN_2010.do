...
global yrfiles "/Users/hayden/Desktop/Research/IN/2010"
...
import excel "/${source}/IN_OriginalData_2005-2015_mat&ela_dist.xlsx", sheet("Spring 2010") cellrange(A2:AL345) firstrow clear
...
tostring ProficientOrAbove_count_ELA_5 ProficientOrAbove_percent_ELA_5 ProficientOrAbove_count_Math_5 ProficientOrAbove_percent_Math_5, replace force
...
save "/${yrfiles}/IN_2010_dist.dta", replace


/////////	Import School Data

import excel "/${source}/IN_OriginalData_2007-2015_mat&ela_sch.xlsx", sheet("Spring 2010") cellrange(A2:AN1573) firstrow clear
...
tostring ProficientOrAbove_count_Math_9 ProficientOrAbove_percent_Math_9, replace force
...
append using "/${yrfiles}/IN_2010_dist.dta"
...
save "/${yrfiles}/IN_2010_base.dta", replace
...
save "/${yrfiles}/IN_2009_NCESDistricts.dta", replace
...
save "/${yrfiles}/IN_2009_NCESSchools.dta", replace


// merge NCES district data

use "/${yrfiles}/IN_2010_base.dta", clear

merge m:1 state_leaid using "/${yrfiles}/IN_2009_NCESDistricts.dta"
drop if _merge==2
drop _merge

merge m:1 state_leaid seasch using "/${yrfiles}/IN_2009_NCESSchools.dta"
drop if _merge==2
drop _merge
...
save "/${yrfiles}/IN_2010.dta", replace
export delimited using "/${output}/IN_AssmtData_2010.csv", replace
