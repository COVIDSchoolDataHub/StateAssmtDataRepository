...
//math and ela
import excel "/${raw}/Pre 2014/IN_OriginalData_2005-2015_mat_ela_dist", sheet("Spring 2010") cellrange(A3:AK343) clear
...
save "/${raw}/Pre 2014/Dist2010", replace


//// School level data files
import excel "/${raw}/Pre 2014/IN_OriginalData_2007-2015_mat_ela_sch", sheet("Spring 2010") cellrange(A3:AM1571) clear
...
save "/${raw}/Pre 2014/School2010", replace


//append all data
append using "/${raw}/Pre 2014/Dist2010.dta"

save "/${raw}/Pre 2014/IN_2010_appended.dta", replace
...
save "${output}/IN_AssmtData_2010.dta", replace

export delimited using "${output}/csv/IN_AssmtData_2010.csv", replace
