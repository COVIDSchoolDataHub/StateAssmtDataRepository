...
global yrfiles "/Users/hayden/Desktop/Research/IN/2005"
...
import excel "/${source}/IN_OriginalData_2005-2015_mat&ela_dist.xlsx", sheet("Fall 2005") cellrange(A2:AV327) firstrow clear
...
save "/${yrfiles}/IN_2005_base.dta", replace

use "/${nces}/NCES_2005_District.dta", clear

keep if state_location=="IN"

save "/${yrfiles}/IN_2005_NCESDistricts.dta", replace


// merge NCES

use "/${yrfiles}/IN_2005_base.dta", clear

merge m:1 state_leaid using "/${yrfiles}/IN_2005_NCESDistricts.dta"
drop if _merge==2
drop _merge
...
save "/${yrfiles}/IN_2005.dta", replace
export delimited using "/${output}/IN_AssmtData_2005.csv", replace
