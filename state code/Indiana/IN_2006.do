...
//math and ela
import excel "/${raw}/Pre 2014/IN_OriginalData_2005-2015_mat_ela_dist", sheet("Fall 2006") cellrange(A3:AU335) clear
...
save "${output}/IN_AssmtData_2006.dta", replace

export delimited using "${output}/csv/IN_AssmtData_2006.csv", replace
