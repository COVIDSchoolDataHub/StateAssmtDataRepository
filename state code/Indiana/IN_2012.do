...
global yrfiles "/Users/hayden/Desktop/Research/IN/2012"
...
import excel "/${source}/IN_OriginalData_2005-2015_mat&ela_dist.xlsx", sheet("Spring 2012") cellrange(A2:AK1342) firstrow clear
...
drop PassBothMathandELAPercent L Q V AA AF AK


// transform from wide to long, generate grade
tostring ProficientOrAbove_count_ELA_5 ProficientOrAbove_percent_ELA_5 ProficientOrAbove_count_Math_5 ProficientOrAbove_percent_Math_5 ProficientOrAbove_count_ELA_6 ProficientOrAbove_percent_ELA_6 ProficientOrAbove_count_Math_6 ProficientOrAbove_percent_Math_6 ProficientOrAbove_count_ELA_8 ProficientOrAbove_percent_ELA_8 ProficientOrAbove_count_Math_8 ProficientOrAbove_percent_Math_8 ProficientOrAbove_count_ELA_9 ProficientOrAbove_percent_ELA_9 ProficientOrAbove_count_Math_9 ProficientOrAbove_percent_Math_9, replace force
...
save "/${yrfiles}/IN_2012_dist.dta", replace


/////////	Import School Data

import excel "/${source}/IN_OriginalData_2007-2015_mat&ela_sch.xlsx", sheet("Spring 2012") cellrange(A2:AM1529) firstrow clear
...
drop PassBothMathandELAPercent N S X AC AH AM
...
rename CorporationID CorpID


save "/${yrfiles}/IN_2012_sch.dta", replace
...
save "/${yrfiles}/IN_2012_state_ela.dta", replace
...
save "/${yrfiles}/IN_2012_state_math.dta", replace


// append all data together
append using "/${yrfiles}/IN_2012_state_ela.dta"
append using "/${yrfiles}/IN_2012_dist.dta"
append using "/${yrfiles}/IN_2012_sch.dta"
...
save "/${yrfiles}/IN_2012_base.dta", replace


// dist

use "/${nces}/NCES_2011_District.dta", clear

keep if state_location=="IN"

save "/${yrfiles}/IN_2011_NCESDistricts.dta", replace


// sch

use "/${nces}/NCES_2011_School.dta", clear

keep if state_location=="IN"

save "/${yrfiles}/IN_2011_NCESSchools.dta", replace


// merge NCES district data

use "/${yrfiles}/IN_2012_base.dta", clear

merge m:1 state_leaid using "/${yrfiles}/IN_2011_NCESDistricts.dta"
drop if _merge==2
drop _merge

merge m:1 state_leaid seasch using "/${yrfiles}/IN_2011_NCESSchools.dta"
drop if _merge==2
drop _merge
...
save "/${yrfiles}/IN_2012.dta", replace
export delimited using "/${output}/IN_AssmtData_2012.csv", replace
