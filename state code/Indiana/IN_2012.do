...
//ela
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("ELA") cellrange(A3:G9) clear
...
save "/${raw}/Pre 2014/StateELA2012", replace

//math
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("Math") cellrange(A3:G9) clear
...
save "/${raw}/Pre 2014/StateMath2012", replace

//sci
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("Science") cellrange(A3:G5) clear
...
save "/${raw}/Pre 2014/StateSci2012", replace

//soc
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("Social Studies") cellrange(A3:G5) clear
...
save "/${raw}/Pre 2014/StateSoc2012", replace

//append all state-level files
use "/${raw}/Pre 2014/StateELA2012", replace
append using "/${raw}/Pre 2014/StateMath2012"
append using "/${raw}/Pre 2014/StateSci2012"
append using "/${raw}/Pre 2014/StateSoc2012"

gen DataLevel = "State"

tostring Proficient*, replace force

save "/${raw}/Pre 2014/State2012", replace

//// Create district level data

//math and ela
import excel "/${raw}/Pre 2014/IN_OriginalData_2005-2015_mat_ela_dist", sheet("Spring 2012") cellrange(A3:AK293) clear
...
save "/${raw}/Pre 2014/Dist2012", replace


//// School level data files
import excel "/${raw}/Pre 2014/IN_OriginalData_2007-2015_mat_ela_sch", sheet("Spring 2012") cellrange(A3:AM1527) clear
...
save "/${raw}/Pre 2014/School2012", replace


//append all data
append using "/${raw}/Pre 2014/Dist2012.dta"
append using "/${raw}/Pre 2014/State2012.dta"

save "/${raw}/Pre 2014/IN_2012_appended.dta", replace
...
merge m:1 State_leaid seasch using "/${NCES}/NCES_2011_School.dta"
...
save "${output}/IN_AssmtData_2012.dta", replace

export delimited using "${output}/csv/IN_AssmtData_2012.csv", replace
