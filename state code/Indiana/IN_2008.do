...
global yrfiles "/Users/hayden/Desktop/Research/IN/2008"
...
import excel "/${source}/IN_OriginalData_2005-2015_mat&ela_dist.xlsx", sheet("Fall 2008") cellrange(A2:AQ348) firstrow clear
...
drop PassBothMathandELAPercent L Q V AA AF AG AH AI AJ AK AL AM AN AO AP AQ
...
save "/${yrfiles}/IN_2008_dist.dta", replace


/////////	Import School Data

import excel "/${source}/IN_OriginalData_2007-2015_mat&ela_sch.xlsx", sheet("Fall 2008") cellrange(A2:AS1836) firstrow clear
...
drop PassBothMathandELAPercent N S X AC AH AI AJ AK AL AM AN AO AP AQ AR AS
...
append using "/${yrfiles}/IN_2008_dist.dta"
...
save "/${yrfiles}/IN_2008_base.dta", replace
...
use "/${yrfiles}/IN_2008_base.dta", clear
...
save "/${yrfiles}/IN_2008.dta", replace
export delimited using "/${output}/IN_AssmtData_2008.csv", replace
