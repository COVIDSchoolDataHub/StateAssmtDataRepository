...
global disagg "/Users/maggie/Desktop/Colorado/Original Data Files/Original Data Files/CMAS Disaggregate-SubPop Data/2018"
...
import excel "${path}/CO_OriginalData_2018_ela_mat.xlsx", sheet("District and School Detail_1") cellrange(A7:X16187) firstrow case(lower) clear
...
save "${path}/CO_OriginalData_2018_ela_math.dta", replace
...
append using "${path}/CO_OriginalData_2018_ela_math.dta"
...
import excel "${disagg}/CO_2018_ELA_gender.xlsx", sheet("Sheet1_1") cellrange(A3:W15648) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_ELA_language.xlsx", sheet("Sheet1_1") cellrange(A3:W22799) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_ELA_raceEthnicity.xlsx", sheet("Sheet1_1") cellrange(A3:W34708) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_ELA_FreeReducedLunch.xlsx", sheet("Sheet1_1") cellrange(A3:W15478) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_mat_gender.xlsx", sheet("Sheet1_1") cellrange(A3:W16400) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_mat_language.xlsx", sheet("Sheet1_1") cellrange(A3:W23480) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_mat_raceEthnicity.xlsx", sheet("Sheet1_1") cellrange(A3:W35937) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_mat_FreeReducedLunch.xlsx", sheet("Sheet1_1") cellrange(A3:W16153) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_sci_gender.xlsx", sheet("Sheet1_1") cellrange(A3:U9248) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_sci_language.xlsx", sheet("Sheet1_1") cellrange(A3:U13174) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_sci_raceEthnicity.xlsx", sheet("Sheet1_1") cellrange(A3:U20327) firstrow case(lower) clear
...
import excel "${disagg}/CO_2018_sci_FreeReducedLunch.xlsx", sheet("Sheet1_1") cellrange(A3:U9147) firstrow case(lower) clear
...
append using "${path}/CO_OriginalData_2018_all.dta"
...
export delimited using "${output}/csv/CO_AssmtData_2018.csv", replace
