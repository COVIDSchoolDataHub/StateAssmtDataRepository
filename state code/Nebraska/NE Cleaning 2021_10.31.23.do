...
//Merge NCES Data
merge m:1 state_leaid using "$NCES/NCES District Files, Fall 1997-Fall 2021/NCES_2020_District.dta"
drop if _merge == 2
drop if _merge == 1 & DataLevel == "District"

merge m:1 seasch state_leaid using "$NCES/NCES School Files, Fall 1997-Fall 2021/NCES_2020_School.dta", gen (merge2)
drop if merge2 == 2
save "$data/NE_AssmtData_2021.dta", replace
...
save "$data/NE_AssmtData_2021.dta", replace
export delimited "$data/NE_AssmtData_2021.csv", replace
clear
