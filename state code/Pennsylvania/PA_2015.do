...
// State Level
import excel "$original_files/PA_OriginalData_2015_all_State.xlsx", sheet("Sheet1") cellrange(A5:I39) firstrow clear
...
save "$temp_files/PA_2015_State.dta", replace

// School Level
import excel "$original_files/PA_OriginalData_2015_all_School.xlsx", sheet("PSSA data (2)") cellrange(A7:N49425) firstrow clear

drop Growth
gen DataLevel = "School"

save "$temp_files/PA_2015_School.dta", replace

// Merging
clear
append using "$temp_files/PA_2015_State.dta" "$temp_files/PA_2015_School.dta"
...
replace GradeLevel = "G38" if GradeLevel == "G0State Total"
...
merge 1:m seasch using "${output_files}/PA_AssmtData_2015.dta", keep(match using) nogenerate
...
merge 1:m ncesdistrictid using "${output_files}/PA_AssmtData_2015.dta", keep(match using) nogenerate
