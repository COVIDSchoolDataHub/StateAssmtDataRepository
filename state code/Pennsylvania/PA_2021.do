...
// State Level
import excel "$original_files/PA_OriginalData_2021_all_State.xlsx", sheet("State data") cellrange(A5:L33) firstrow clear
...
drop DifferenceinNumberScoredFrom
drop PercentReductionFrom2019
drop Year

save "$temp_files/PA_2021_State.dta", replace

// School Level
import excel "$original_files/PA_OriginalData_2021_all_School.xlsx", sheet("web") cellrange(A7:O47226) firstrow clear
...
drop DifferenceinNumberScoredFrom
drop ReductionFrom2019

save "$temp_files/PA_2021_School.dta", replace

// Merging
clear
append using "$temp_files/PA_2021_State.dta" "$temp_files/PA_2021_School.dta"
...
merge 1:m seasch using "${output_files}/PA_AssmtData_2021.dta", keep(match using) nogenerate
...
merge 1:m ncesdistrictid using "${output_files}/PA_AssmtData_2021.dta", keep(match using) nogenerate
