...
forvalues i = 3/8 {
	...
	clear
	append using "$temp_files/FL_OriginalData_2018_DistState_ELA_G0`i'.dta" "$temp_files/FL_OriginalData_2018_DistState_M_G0`i'.dta"
	...
	save "$temp_files/FL_OriginalData_2018_DistState_MELA_G0`i'.dta", replace
	...
	clear
	append using "$temp_files/FL_OriginalData_2018_School_ELA_G0`i'.dta" "$temp_files/FL_OriginalData_2018_School_M_G0`i'.dta"
	...
	save "$temp_files/FL_OriginalData_2018_School_MELA_G0`i'.dta", replace
	
	clear
	append using "$temp_files/FL_OriginalData_2018_DistState_MELA_G0`i'.dta" "$temp_files/FL_OriginalData_2018_School_MELA_G0`i'.dta"
	save "$temp_files/FL_OriginalData_2018_All_MELA_G0`i'.dta", replace
}

foreach i in 5 8 {
	import excel "$original_files/FL_OriginalData_2018_DistState_S_G0`i'", cellrange(A9) firstrow allstring clear
	
	keep Grade DistrictNumber DistrictName NumberofStudents MeanScaleScore F G H I J PercentagePassingAchievement
	...
	keep Grade DistrictNumber DistrictName SchoolNumber SchoolName NumberofStudents MeanScaleScore H I J K L PercentagePassingAchievement
	drop if DistrictNumber == "Number of Points Possible"
	gen DataLevel = "School"
	drop if DistrictName == "STATE TOTALS"
	...
	clear
	append using "$temp_files/FL_OriginalData_2018_DistState_S_G0`i'.dta" "$temp_files/FL_OriginalData_2018_School_S_G0`i'.dta"
	gen Subject = "sci"
	save "$temp_files/FL_OriginalData_2018_All_S_G0`i'.dta", replace
}

clear
append using "$temp_files/FL_OriginalData_2018_All_MELA_G03.dta" "$temp_files/FL_OriginalData_2018_All_MELA_G04.dta" "$temp_files/FL_OriginalData_2018_All_MELA_G05.dta" "$temp_files/FL_OriginalData_2018_All_MELA_G06.dta" "$temp_files/FL_OriginalData_2018_All_MELA_G07.dta" "$temp_files/FL_OriginalData_2018_All_MELA_G08.dta" "$temp_files/FL_OriginalData_2018_All_S_G05.dta" "$temp_files/FL_OriginalData_2018_All_S_G08.dta"
save "$temp_files/FL_OriginalData_2018_All_All_All.dta", replace


use "$temp_files/FL_OriginalData_2018_All_All_All.dta", clear
...
save "$output_files/FL_AssmtData_2018.dta", replace
...
merge 1:m seasch using "${output_files}/FL_AssmtData_2018.dta", keep(match using)
...
merge 1:m state_leaid using "${output_files}/FL_AssmtData_2018.dta", keep(match using) nogenerate
...
save "${output_files}/FL_AssmtData_2018.dta", replace
export delimited using "$output_files/FL_AssmtData_2018.csv", replace
