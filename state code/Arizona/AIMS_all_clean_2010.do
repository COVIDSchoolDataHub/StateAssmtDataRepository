...
import excel "${raw}/AZ_OriginalData_2010_all.xlsx", sheet("School by Grade") firstrow clear
...
import excel "${raw}/AZ_OriginalData_2010_all.xlsx", sheet("District by Grade") firstrow clear
...
import excel "${raw}/AZ_OriginalData_2010_all.xlsx", sheet("State by Grade") firstrow clear
