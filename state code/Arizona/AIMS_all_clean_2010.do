...
import excel "${raw}/AZ_OriginalData_2010_all.xls", sheet("School by Grade") firstrow clear
...
merge m:1 StateAssignedSchID using "${NCES}/NCES_2010_School.dta"
...
import excel "${raw}/AZ_OriginalData_2010_all.xls", sheet("District by Grade") firstrow clear
...
import excel "${raw}/AZ_OriginalData_2010_all.xls", sheet("State by Grade") firstrow clear
...
export delimited using "/Users/minnamgung/Desktop/Arizona/Output/Unmerged/AZ_AssmtData_unmerged_2010.csv", replace
...
export delimited using "/Users/minnamgung/Desktop/Arizona/Output/AIMS/csv/AZ_AssmtData_2010.csv", replace
