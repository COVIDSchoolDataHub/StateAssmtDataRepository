...
import excel "${raw}/AZ_OriginalData_2013_all.xls", sheet("School by Grade") firstrow clear
...
merge m:1 StateAssignedSchID using "${NCES}/NCES_2013_School.dta"
...
import excel "${raw}/AZ_OriginalData_2013_all.xls", sheet("District by Grade") firstrow clear
...
import excel "${raw}/AZ_OriginalData_2013_all.xls", sheet("State by Grade") firstrow clear
