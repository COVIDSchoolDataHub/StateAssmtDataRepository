...
use "${output}/AZ_AssmtData_school_sci_2015.dta", clear
...
use "${output}/AZ_AssmtData_district_sci_2015.dta", clear 
...
use "${output}/AZ_AssmtData_state_sci_2015.dta", clear
