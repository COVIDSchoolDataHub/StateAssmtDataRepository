...
use "${dta}/AZ_AssmtData_school_2017.dta", clear
...
use "${dta}/AZ_AssmtData_school_sci_2017.dta", clear
...
merge m:1 StateAssignedSchID using "${NCES}/NCES_2017_School.dta"
...
use "${dta}/AZ_AssmtData_district_2017.dta", clear
...
use "${dta}/AZ_AssmtData_district_sci_2017.dta", clear 
...
use "${dta}/AZ_AssmtData_state_2017.dta", clear
...
use "${dta}/AZ_AssmtData_state_sci_2017.dta", clear
...
export delimited using "/Users/minnamgung/Desktop/Arizona/Output/Unmerged/AZ_AssmtData_unmerged_2017.csv", replace

use "${output}/AZ_AssmtData_2017.dta", clear
...
replace StudentGroup="Economic status" if inlist(StudentSubGroup, "Economically Disadvantaged", "Homeless", "Economic Disadvantage")
