...
import excel "${raw}/AZ_OriginalData_2011_all.xls", sheet("School by Grade") firstrow clear
...
merge m:1 StateAssignedSchID using "${NCES}/NCES_2011_School.dta"
...
import excel "${raw}/AZ_OriginalData_2011_all.xls", sheet("District by Grade") firstrow clear
...
import excel "${raw}/AZ_OriginalData_2011_all.xls", sheet("State by Grade") firstrow clear
