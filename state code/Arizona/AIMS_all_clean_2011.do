...
import excel "${raw}/AZ_OriginalData_2011_all.xlsx", sheet("School by Grade") firstrow clear
...
merge m:1 State_leaid using "${NCES}/NCES_2010_District.dta", force
drop _merge
drop if State == ""

tostring StateAssignedSchID, generate(seasch)

merge m:1 seasch NCESDistrictID using "${NCES}/NCES_2010_School.dta", force
drop _merge
drop if State == ""
...
import excel "${raw}/AZ_OriginalData_2011_all.xlsx", sheet("District by Grade") firstrow clear
...
import excel "${raw}/AZ_OriginalData_2011_all.xlsx", sheet("State by Grade") firstrow clear
