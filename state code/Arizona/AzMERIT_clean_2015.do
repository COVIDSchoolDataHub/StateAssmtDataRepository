...
import excel "${raw}/AZ_OriginalData_2015_all.xlsx", sheet("SCHOOLS") firstrow clear

save "${dta}/AZ_AssmtData_school_2015.dta", replace

import excel "${raw}/AZ_OriginalData_2015_all.xlsx", sheet("DISTRICTS_CHARTER HOLDERS") firstrow clear                       
save "${dta}/AZ_AssmtData_district_2015.dta", replace

import excel "${raw}/AZ_OriginalData_2015_all.xlsx", sheet("STATE") firstrow clear

save "${dta}/AZ_AssmtData_state_2015.dta", replace

** 2015 Science

import excel "${raw}/AZ_OriginalData_2015_sci.xls", sheet("2015SchoolGrade") firstrow clear

save "${dta}/AZ_AssmtData_school_sci_2015.dta", replace

import excel "${raw}/AZ_OriginalData_2015_sci.xls", sheet("2015LEAGrade") firstrow clear

save "${dta}/AZ_AssmtData_district_sci_2015.dta", replace

import excel "${raw}/AZ_OriginalData_2015_sci.xls", sheet("2015StateGrade") firstrow clear

save "${dta}/AZ_AssmtData_state_sci_2015.dta", replace
...
use "${dta}/AZ_AssmtData_school_2015.dta", clear
...
use "${dta}/AZ_AssmtData_school_sci_2015.dta", clear
...
merge m:1 StateAssignedSchID using "${NCES}/NCES_2015_School.dta"
...
use "${dta}/AZ_AssmtData_district_2015.dta", clear
...
use "${dta}/AZ_AssmtData_district_sci_2015.dta", clear 
...
use "${dta}/AZ_AssmtData_state_2015.dta", clear
...
use "${dta}/AZ_AssmtData_state_sci_2015.dta", clear
...
append using "${output}/AZ_AssmtData_district_2015.dta"

save "${output}/AZ_AssmtData_2015.dta", replace

append using "${output}/AZ_AssmtData_state_2015.dta"
...
export delimited using "/Users/minnamgung/Desktop/Arizona/Output/Unmerged/AZ_AssmtData_unmerged_2015.csv", replace

use "${output}/AZ_AssmtData_2015.dta", clear
...
drop SchoolCTDSNumber DistrictCharterHolderCTDSNum LocalEducationAgencyLEACTD year lea_name

sort DataLevel StateAssignedDistID StateAssignedSchID GradeLevel Subject

save "${output}/AZ_AssmtData_2015.dta", replace

export delimited using"/Users/minnamgung/Desktop/Arizona/Output/AIMS/csv/AZ_AssmtData_2015.csv", replace
