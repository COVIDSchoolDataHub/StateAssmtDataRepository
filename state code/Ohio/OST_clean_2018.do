...
import excel "${raw}/OH_OriginalData_District_2018.xlsx", sheet("Performance_Indicators") firstrow clear
...
* Gender Files
import excel "${raw}/OH_OriginalData_Gender_District_2018.xlsx", sheet("District_Gender") clear
...
save "${dta}/OH_DistData_Gender_2018.dta", replace

* EL Status Files
import excel "${raw}/OH_OriginalData_EL Status_District_2018.xlsx", sheet("District_LEP") clear
drop C D T U V W X Y Z AA AB AC AD AE AF AG AH AI
...
save "${dta}/OH_DistData_EL Status_2018.dta", replace

* Economic Status Files
import excel "${raw}/OH_OriginalData_Econ_District_2018.xlsx", sheet("District_Econ_Disadvantaged") clear
drop C D T U V W X Y Z AA AB AC AD AE AF AG AH AI
...
save "${dta}/OH_DistData_Econ Status_2018.dta", replace

* RaceEth Files
import excel "${raw}/OH_OriginalData_RaceEth_District_2018.xlsx", sheet("District_Race") clear
drop C D T U V W X Y Z AA AB AC AD AE AF AG AH AI
...
save "${dta}/OH_DistData_RaceEth_2018.dta", replace

//School Data - All Students
import excel "${raw}/OH_OriginalData_School_2018.xlsx", sheet("Performance_Indicators") clear
...
save "${dta}/OH_SchoolData_2018.dta", replace

* Gender Files
import excel "${raw}/OH_OriginalData_Gender_School_2018.xlsx", sheet("BUILDING_GENDER") clear
drop E F G H X Y Z AA AB AC AD AE AF AG AH AI AJ AK AL
...
rename M ProficientOrAbove_pct_G04_math
rename N ProficientOrAbove_pct_G05_ela
rename O ProficientOrAbove_pct_G05_math
rename P ProficientOrAbove_pct_G05_sci
rename Q ProficientOrAbove_pct_G06_ela
rename R ProficientOrAbove_pct_G06_math
rename S ProficientOrAbove_pct_G07_ela
rename T ProficientOrAbove_pct_G07_math
rename U ProficientOrAbove_pct_G08_ela
rename V ProficientOrAbove_pct_G08_math
rename W ProficientOrAbove_pct_G08_sci
...
save "${dta}/OH_SchoolData_Gender_2018.dta", replace

* EL Status Files
import excel "${raw}/OH_OriginalData_EL Status_School_2018.xlsx", sheet("BUILDING_LEP") clear
drop E F G H X Y Z AA AB AC AD AE AF AG AH AI AJ AK AL
...
save "${dta}/OH_SchoolData_EL Status_2018.dta", replace

* Economic Status Files
import excel "${raw}/OH_OriginalData_Econ_School_2018.xlsx", sheet("BUILDING_ECON_DIS") clear
drop E F G H X Y Z AA AB AC AD AE AF AG AH AI AJ AK AL
...
save "${dta}/OH_SchoolData_Econ Status_2018.dta", replace

* RaceEth Files
import excel "${raw}/OH_OriginalData_RaceEth_School_2018.xlsx", sheet("BUILDING_ETHNIC_1718") clear
drop E F G H X Y Z AA AB AC AD AE AF AG AH AI AJ AK AL
...
save "${dta}/OH_SchoolData_RaceEth_2018.dta", replace
...
save "$NCES_clean/NCES_2018_School_OH.dta", replace

* Merge Data
use "$dta/OH_AssmtData_2018.dta", clear
append using "${dta}/OH_DistData_Gender_2018.dta" "${dta}/OH_DistData_EL Status_2018.dta" "${dta}/OH_DistData_Econ Status_2018.dta" "${dta}/OH_DistData_RaceEth_2018.dta" "${dta}/OH_SchoolData_2018.dta" "${dta}/OH_SchoolData_Gender_2018.dta" "${dta}/OH_SchoolData_EL Status_2018.dta" "${dta}/OH_SchoolData_Econ Status_2018.dta" "${dta}/OH_SchoolData_RaceEth_2018.dta"

merge m:1 StateAssignedDistID using "$NCES_clean/NCES_2018_District_OH.dta"
drop if _merge == 2

merge m:1 StateAssignedSchID StateAssignedDistID using "$NCES_clean/NCES_2018_School_OH.dta", gen (merge2)
drop if merge2 == 2
...
import excel "${raw}/OH_OriginalData_District_2018.xlsx", sheet("Performance_Indicators") clear
...
replace NCESSchoolID = "390033104868" if SchName == "Coshocton Opportunity School"
replace SchType = "Regular school" if SchName == "Coshocton Opportunity School"
replace seasch = "000598" if SchName == "Coshocton Opportunity School"
replace SchLevel = "High" if SchName == "Coshocton Opportunity School"
replace SchVirtual = "Missing/not reported" if SchName == "Coshocton Opportunity School"

replace NCESSchoolID = "390064205309" if SchName == "Dayton Business Technology High School"
replace SchType = "Regular school" if SchName == "Dayton Business Technology High School"
replace seasch = "008283" if SchName == "Dayton Business Technology High School"
replace SchLevel = "High" if SchName == "Dayton Business Technology High School"
replace SchVirtual = "Missing/not reported" if SchName == "Dayton Business Technology High School"
...
replace NCESSchoolID = "390015504767" if SchName == "Fairborn Digital Academy"
replace SchType = "Regular school" if SchName == "Fairborn Digital Academy"
replace seasch = "149088" if SchName == "Fairborn Digital Academy"
replace SchLevel = "High" if SchName == "Fairborn Digital Academy"
replace SchVirtual = "Yes" if SchName == "Fairborn Digital Academy"

replace NCESSchoolID = "390052805238" if SchName == "Findlay Digital Academy"
replace SchType = "Regular school" if SchName == "Findlay Digital Academy"
replace seasch = "000402" if SchName == "Findlay Digital Academy"
replace SchLevel = "High" if SchName == "Findlay Digital Academy"
replace SchVirtual = "Yes" if SchName == "Findlay Digital Academy"
...
replace NCESSchoolID = "390488406002" if SchName == "Franklin Local Community School"
replace SchType = "Regular school" if SchName == "Franklin Local Community School"
replace seasch = "017494" if SchName == "Franklin Local Community School"
replace SchLevel = "Missing/not reported" if SchName == "Franklin Local Community School"
replace SchVirtual = "Missing/not reported" if SchName == "Franklin Local Community School"

replace DistName = "Global Village Academy" if SchName == "Global Village Academy"
replace NCESDistrictID = "3901465" if SchName == "Global Village Academy"
replace State_leaid = "012558" if SchName == "Global Village Academy"
replace DistCharter = "Yes" if SchName == "Global Village Academy"
replace DistType = "Charter agency" if SchName == "Global Village Academy"
replace NCESSchoolID = "390146505658" if SchName == "Global Village Academy"
replace SchType = "Regular school" if SchName == "Global Village Academy"
replace seasch = "012558" if SchName == "Global Village Academy"
replace SchLevel = "Primary" if SchName == "Global Village Academy"
replace SchVirtual = "No" if SchName == "Global Village Academy"
replace CountyName = "Cuyahoga County" if SchName == "Global Village Academy"
replace CountyCode = 39035 if SchName == "Global Village Academy"
...
replace DistName = "Imagine Akron Academy" if SchName == "Imagine Akron Academy"
replace NCESDistrictID = "3901377" if SchName == "Imagine Akron Academy"
replace State_leaid = "011947" if SchName == "Imagine Akron Academy"
replace DistCharter = "Yes" if SchName == "Imagine Akron Academy"
replace DistType = "Charter agency" if SchName == "Imagine Akron Academy"
replace NCESSchoolID = "390137705630" if SchName == "Imagine Akron Academy"
replace SchType = "Regular school" if SchName == "Imagine Akron Academy"
replace seasch = "011947" if SchName == "Imagine Akron Academy"
replace SchLevel = "Primary" if SchName == "Imagine Akron Academy"
replace SchVirtual = "No" if SchName == "Imagine Akron Academy"
replace CountyName = "Summit County" if SchName == "Imagine Akron Academy"
replace CountyCode = 39153 if SchName == "Imagine Akron Academy"
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Lakewood City Academy"
replace SchType = "Missing/not reported" if SchName == "Lakewood City Academy"
replace seasch = "Missing/not reported" if SchName == "Lakewood City Academy"
replace SchLevel = "Missing/not reported" if SchName == "Lakewood City Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Lakewood City Academy"

replace NCESDistrictID = "Missing/not reported" if SchName == "Lorain K-12 Digital Academy"
replace State_leaid = "Missing/not reported" if SchName == "Lorain K-12 Digital Academy"
replace DistCharter = "Missing/not reported" if SchName == "Lorain K-12 Digital Academy"
replace DistType = "Missing/not reported" if SchName == "Lorain K-12 Digital Academy"
...
replace CountyName = "Missing/not reported" if SchName == "Lorain K-12 Digital Academy"

replace NCESSchoolID = "Missing/not reported" if SchName == "Massillon Digital Academy, Inc"
replace SchType = "Missing/not reported" if SchName == "Massillon Digital Academy, Inc"
replace seasch = "Missing/not reported" if SchName == "Massillon Digital Academy, Inc"
replace SchLevel = "Missing/not reported" if SchName == "Massillon Digital Academy, Inc"
replace SchVirtual = "Missing/not reported" if SchName == "Massillon Digital Academy, Inc"
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Miamisburg Secondary Academy"
replace SchType = "Missing/not reported" if SchName == "Miamisburg Secondary Academy"
replace seasch = "Missing/not reported" if SchName == "Miamisburg Secondary Academy"
replace SchLevel = "Missing/not reported" if SchName == "Miamisburg Secondary Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Miamisburg Secondary Academy"
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Newark Digital Academy"
replace SchType = "Missing/not reported" if SchName == "Newark Digital Academy"
replace seasch = "Missing/not reported" if SchName == "Newark Digital Academy"
replace SchLevel = "Missing/not reported" if SchName == "Newark Digital Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Newark Digital Academy"
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Phoenix Academy Community School"
replace SchType = "Missing/not reported" if SchName == "Phoenix Academy Community School"
replace seasch = "Missing/not reported" if SchName == "Phoenix Academy Community School"
replace SchLevel = "Missing/not reported" if SchName == "Phoenix Academy Community School"
replace SchVirtual = "Missing/not reported" if SchName == "Phoenix Academy Community School"
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Polly Fox Academy Community School"
replace SchType = "Missing/not reported" if SchName == "Polly Fox Academy Community School"
replace seasch = "Missing/not reported" if SchName == "Polly Fox Academy Community School"
replace SchLevel = "Missing/not reported" if SchName == "Polly Fox Academy Community School"
replace SchVirtual = "Missing/not reported" if SchName == "Polly Fox Academy Community School"

replace DistName = "Promise Academy" if SchName == "Promise Academy"
replace NCESDistrictID = "3900562" if SchName == "Promise Academy"
replace State_leaid = "000936" if SchName == "Promise Academy"
replace DistCharter = "Yes" if SchName == "Promise Academy"
replace DistType = "Charter agency" if SchName == "Promise Academy"
replace NCESSchoolID = "390056205054" if SchName == "Promise Academy"
replace SchType = "Regular school" if SchName == "Promise Academy"
replace seasch = "000936" if SchName == "Promise Academy"
replace SchLevel = "High" if SchName == "Promise Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Promise Academy"
replace CountyName = "Cuyahoga County" if SchName == "Promise Academy"
replace CountyCode = 39035 if SchName == "Promise Academy"

replace DistName = "Quaker Digital Academy" if SchName == "Quaker Digital Academy"
replace NCESDistrictID = "3900252" if SchName == "Quaker Digital Academy"
replace State_leaid = "000241" if SchName == "Quaker Digital Academy"
replace DistCharter = "Yes" if SchName == "Quaker Digital Academy"
replace DistType = "Charter agency" if SchName == "Quaker Digital Academy"
replace NCESSchoolID = "390025205195" if SchName == "Quaker Digital Academy"
replace SchType = "Regular school" if SchName == "Quaker Digital Academy"
replace seasch = "000241" if SchName == "Quaker Digital Academy"
replace SchLevel = "Other" if SchName == "Quaker Digital Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Quaker Digital Academy"
replace CountyName = "Tuscarawas County" if SchName == "Quaker Digital Academy"
replace CountyCode = 39157 if SchName == "Quaker Digital Academy"
...
replace DistName = "Rittman Academy" if SchName == "Rittman Academy"
replace NCESDistrictID = "3900366" if SchName == "Rittman Academy"
replace State_leaid = "000640" if SchName == "Rittman Academy"
replace DistCharter = "Yes" if SchName == "Rittman Academy"
replace DistType = "Charter agency" if SchName == "Rittman Academy"
replace NCESSchoolID = "390036604903" if SchName == "Rittman Academy"
replace SchType = "Regular school" if SchName == "Rittman Academy"
replace seasch = "000640" if SchName == "Rittman Academy"
replace SchLevel = "High" if SchName == "Rittman Academy"
replace SchVirtual = "No" if SchName == "Rittman Academy"
replace CountyName = "Wayne County" if SchName == "Rittman Academy"
replace CountyCode = 39169 if SchName == "Rittman Academy"

replace NCESSchoolID = "Missing/not reported" if SchName == "Rushmore Academy"
replace SchType = "Missing/not reported" if SchName == "Rushmore Academy"
replace seasch = "Missing/not reported" if SchName == "Rushmore Academy"
replace SchLevel = "Missing/not reported" if SchName == "Rushmore Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Rushmore Academy"

replace DistName = "Schnee Learning Center" if SchName == "Schnee Learning Center"
replace NCESDistrictID = "3900385" if SchName == "Schnee Learning Center"
replace State_leaid = "147231" if SchName == "Schnee Learning Center"
replace DistCharter = "Yes" if SchName == "Schnee Learning Center"
replace DistType = "Charter agency" if SchName == "Schnee Learning Center"
replace NCESSchoolID = "390038504528" if SchName == "Schnee Learning Center"
replace SchType = "Regular school" if SchName == "Schnee Learning Center"
replace seasch = "147231" if SchName == "Schnee Learning Center"
replace SchLevel = "High" if SchName == "Schnee Learning Center"
replace SchVirtual = "Missing/not reported" if SchName == "Schnee Learning Center"
replace CountyName = "Summit County" if SchName == "Schnee Learning Center"
replace CountyCode = 39153 if SchName == "Schnee Learning Center"
...
replace DistName = "The Richland School of Academic Arts" if SchName == "The Richland School of Academic Arts"
replace NCESDistrictID = "3901381" if SchName == "The Richland School of Academic Arts"
replace State_leaid = "011967" if SchName == "The Richland School of Academic Arts"
replace DistCharter = "Yes" if SchName == "The Richland School of Academic Arts"
replace DistType = "Charter agency" if SchName == "The Richland School of Academic Arts"
replace NCESSchoolID = "390138105634" if SchName == "The Richland School of Academic Arts"
replace SchType = "Regular school" if SchName == "The Richland School of Academic Arts"
replace seasch = "011967" if SchName == "The Richland School of Academic Arts"
replace SchLevel = "Other" if SchName == "The Richland School of Academic Arts"
replace SchVirtual = "Missing/not reported" if SchName == "The Richland School of Academic Arts"
replace CountyName = "Richland County" if SchName == "The Richland School of Academic Arts"
replace CountyCode = 39139 if SchName == "The Richland School of Academic Arts"

replace DistName = "Tomorrow Center" if SchName == "Tomorrow Center"
replace NCESDistrictID = "3900145" if SchName == "Tomorrow Center"
replace State_leaid = "148981" if SchName == "Tomorrow Center"
replace DistCharter = "Yes" if SchName == "Tomorrow Center"
replace DistType = "Charter agency" if SchName == "Tomorrow Center"
replace NCESSchoolID = "390014504757" if SchName == "Tomorrow Center"
replace SchType = "Regular school" if SchName == "Tomorrow Center"
replace seasch = "148981" if SchName == "Tomorrow Center"
replace SchLevel = "High" if SchName == "Tomorrow Center"
replace SchVirtual = "Missing/not reported" if SchName == "Tomorrow Center"
replace CountyName = "Morrow County" if SchName == "Tomorrow Center"
replace CountyCode = 39117 if SchName == "Tomorrow Center"

replace DistName = "Townsend North Community School" if SchName == "Townsend North Community School"
replace NCESDistrictID = "3901450" if SchName == "Townsend North Community School"
replace State_leaid = "012867" if SchName == "Townsend North Community School"
replace DistCharter = "Yes" if SchName == "Townsend North Community School"
replace DistType = "Charter agency" if SchName == "Townsend North Community School"
replace NCESSchoolID = "390145005693" if SchName == "Townsend North Community School"
replace SchType = "Regular school" if SchName == "Townsend North Community School"
replace seasch = "012867" if SchName == "Townsend North Community School"
replace SchLevel = "High" if SchName == "Townsend North Community School"
replace SchVirtual = "Missing/not reported" if SchName == "Townsend North Community School"
replace CountyName = "Erie County" if SchName == "Townsend North Community School"
replace CountyCode = 39043 if SchName == "Townsend North Community School"
...
replace DistName = "Zanesville Community School" if SchName == "Zanesville Community School"
replace NCESDistrictID = "3901314" if SchName == "Zanesville Community School"
replace State_leaid = "009148" if SchName == "Zanesville Community School"
replace DistCharter = "Yes" if SchName == "Zanesville Community School"
replace DistType = "Charter agency" if SchName == "Zanesville Community School"
replace NCESSchoolID = "390131405407" if SchName == "Zanesville Community School"
replace SchType = "Regular school" if SchName == "Zanesville Community School"
replace seasch = "009148" if SchName == "Zanesville Community School"
replace SchLevel = "High" if SchName == "Zanesville Community School"
replace SchVirtual = "Missing/not reported" if SchName == "Zanesville Community School"
replace CountyName = "Muskingum County" if SchName == "Zanesville Community School"
replace CountyCode = 39119 if SchName == "Zanesville Community School"
