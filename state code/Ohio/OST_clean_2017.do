...
import excel "${raw}/OH_OriginalData_District_2017.xls", sheet("Performance_Indicators") firstrow clear
...
import excel "${raw}/OH_OriginalData_District_2017.xls", sheet("Performance_Indicators") clear
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Foxfire East Academy"
replace SchType = "Missing/not reported" if SchName == "Foxfire East Academy"
replace seasch = "Missing/not reported" if SchName == "Foxfire East Academy"
replace SchLevel = "Missing/not reported" if SchName == "Foxfire East Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Foxfire East Academy"
...
replace DistName = "Mansfield Elective Academy" if SchName == "Mansfield Elective Academy"
replace NCESDistrictID = "3900525" if SchName == "Mansfield Elective Academy"
replace State_leaid = "000396" if SchName == "Mansfield Elective Academy"
replace DistCharter = "Yes" if SchName == "Mansfield Elective Academy"
replace DistType = "Charter agency" if SchName == "Mansfield Elective Academy"
replace NCESSchoolID = "390052505235" if SchName == "Mansfield Elective Academy"
replace SchType = "Regular school" if SchName == "Mansfield Elective Academy"
replace seasch = "000396" if SchName == "Mansfield Elective Academy"
replace SchLevel = "Primary" if SchName == "Mansfield Elective Academy"
replace SchVirtual = "No" if SchName == "Mansfield Elective Academy"
replace CountyName = "Richland County" if SchName == "Mansfield Elective Academy"
replace CountyCode = 39139 if SchName == "Mansfield Elective Academy"

replace NCESSchoolID = "Missing/not reported" if SchName == "Marion City Digital Academy"
replace SchType = "Missing/not reported" if SchName == "Marion City Digital Academy"
replace seasch = "Missing/not reported" if SchName == "Marion City Digital Academy"
replace SchLevel = "Missing/not reported" if SchName == "Marion City Digital Academy"
replace SchVirtual = "Missing/not reported" if SchName == "Marion City Digital Academy"
...
replace DistName = "Quest Community School" if SchName == "Quest Community School"
replace NCESDistrictID = "3901424" if SchName == "Quest Community School"
replace State_leaid = "012078" if SchName == "Quest Community School"
replace DistCharter = "Yes" if SchName == "Quest Community School"
replace DistType = "Charter agency" if SchName == "Quest Community School"
replace NCESSchoolID = "390142405589" if SchName == "Quest Community School"
replace SchType = "Regular school" if SchName == "Quest Community School"
replace seasch = "012078" if SchName == "Quest Community School"
replace SchLevel = "High" if SchName == "Quest Community School"
replace SchVirtual = "No" if SchName == "Quest Community School"
replace CountyName = "Cuyahoga County" if SchName == "Quest Community School"
replace CountyCode = 39035 if SchName == "Quest Community School"
...
replace NCESSchoolID = "Missing/not reported" if SchName == "Urbana Community School"
replace SchType = "Missing/not reported" if SchName == "Urbana Community School"
replace seasch = "Missing/not reported" if SchName == "Urbana Community School"
replace SchLevel = "Missing/not reported" if SchName == "Urbana Community School"
replace SchVirtual = "Missing/not reported" if SchName == "Urbana Community School"
