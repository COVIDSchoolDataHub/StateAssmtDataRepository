...
use "${output}/MO_AssmtData_2021_state.dta", clear
append using "${output}/MO_AssmtData_2021_district.dta"
append using "${output}/MO_AssmtData_2021_school.dta"
...
save "${output}/MO_AssmtData_2021.dta", replace

export delimited using "${output}/csv/MO_AssmtData_2021.csv", replace
