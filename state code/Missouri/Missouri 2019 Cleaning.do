...
use "${output}/MO_AssmtData_2019_state.dta", clear
append using "${output}/MO_AssmtData_2019_district.dta"
append using "${output}/MO_AssmtData_2019_school.dta"
...
save "${output}/MO_AssmtData_2019.dta", replace

export delimited using "${output}/csv/MO_AssmtData_2019.csv", replace
