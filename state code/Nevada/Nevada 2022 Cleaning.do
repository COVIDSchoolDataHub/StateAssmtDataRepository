...
use "${output}/NV_AssmtData_2022_ela.dta", clear
...
save "${output}/NV_AssmtData_2022_elaappend.dta", replace

use "${output}/NV_AssmtData_2022_math.dta", clear
...
save "${output}/NV_AssmtData_2022_mathappend.dta", replace

use "${output}/NV_AssmtData_2022_sci.dta", clear
...
append using "${output}/NV_AssmtData_2022_elaappend.dta"
append using "${output}/NV_AssmtData_2022_mathappend.dta"
