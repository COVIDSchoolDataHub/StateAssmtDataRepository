...
use "${output}/NV_AssmtData_2016_ela.dta", clear

rename Year SchYear
rename ELANumberTested StudentSubGroup_TotalTested
rename ReadingTested ParticipationRate
rename ELAProficient ProficientOrAbove_percent
rename ELAEmergentDeveloping Lev1_percent
rename ELAApproachesStandard Lev2_percent
rename ELAMeetsStandard Lev3_percent
rename ELAExceedsStandard Lev4_percent

gen Subject = "ela"

save "${output}/NV_AssmtData_2016_elaappend.dta", replace

use "${output}/NV_AssmtData_2016_math.dta", clear

rename Year SchYear
rename MathematicsNumberTested StudentSubGroup_TotalTested
rename MathematicsTested ParticipationRate
rename MathematicsEmergentDeveloping Lev1_percent
rename MathematicsApproachesStandard Lev2_percent
rename MathematicsMeetsStandard Lev3_percent
rename MathematicsExceedsStandard Lev4_percent
rename MathematicsProficient ProficientOrAbove_percent

gen Subject = "math"

append using "${output}/NV_AssmtData_2016_elaappend.dta"

** Dropping extra variables

drop EligibleforCRTELAMath ELANotTested MathematicsNotTested
