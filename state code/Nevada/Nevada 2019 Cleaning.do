...
use "${output}/NV_AssmtData_2019_ela.dta", clear
...
save "${output}/NV_AssmtData_2019_elaappend.dta", replace

use "${output}/NV_AssmtData_2019_math.dta", clear
...
save "${output}/NV_AssmtData_2019_mathappend.dta", replace

use "${output}/NV_AssmtData_2019_sci.dta", clear
...
append using "${output}/NV_AssmtData_2019_elaappend.dta"
append using "${output}/NV_AssmtData_2019_mathappend.dta"
