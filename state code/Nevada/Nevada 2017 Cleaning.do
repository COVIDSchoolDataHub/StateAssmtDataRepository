...
use "${output}/NV_AssmtData_2017_ela.dta", clear
...
save "${output}/NV_AssmtData_2017_elaappend.dta", replace

use "${output}/NV_AssmtData_2017_math.dta", clear
...
save "${output}/NV_AssmtData_2017_mathappend.dta", replace

use "${output}/NV_AssmtData_2017_sci.dta", clear
...
append using "${output}/NV_AssmtData_2017_elaappend.dta"
append using "${output}/NV_AssmtData_2017_mathappend.dta"
