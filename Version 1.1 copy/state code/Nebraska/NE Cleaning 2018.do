...
merge m:1 seasch state_leaid using "$NCES/NCES_2017_School.dta", gen (merge2)
drop if merge2 == 2
save "$data/NE_AssmtData_2018.dta", replace
...
save "$output/NE_AssmtData_2018.dta", replace
export delimited "$output/NE_AssmtData_2018", replace
clear
