...
merge m:1 State_leaid using "${nces}/1_NCES_2011_District"
...
merge m:1 seasch1 using "${nces}/1_NCES_2011_School.dta", force
...
replace ParticipationRate = "--" if real(ParticipationRate) > 1.05 & !missing(real(ParticipationRate))
