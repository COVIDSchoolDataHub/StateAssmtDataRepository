...
//ela
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("ELA") cellrange(A3:I9) clear
...
save "/${raw}/Pre 2014/StateELA2011", replace

//math
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("Math") cellrange(A3:I9) clear
...
save "/${raw}/Pre 2014/StateMath2011", replace

//sci
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("Science") cellrange(A3:I5) clear
...
save "/${raw}/Pre 2014/StateSci2011", replace

//soc
import excel "/${raw}/Pre 2014/IN_OriginalData_2011-2014_mat_ela_state.xlsx", sheet("Social Studies") cellrange(A3:I5) clear
...
save "/${raw}/Pre 2014/StateSoc2011", replace

//append all state-level files
use "/${raw}/Pre 2014/StateELA2011", replace
append using "/${raw}/Pre 2014/StateMath2011"
append using "/${raw}/Pre 2014/StateSci2011"
append using "/${raw}/Pre 2014/StateSoc2011"

gen DataLevel = "State"

tostring Proficient*, replace force

save "/${raw}/Pre 2014/State2011", replace

//// Create district level data

//math and ela
import excel "/${raw}/Pre 2014/IN_OriginalData_2005-2015_mat_ela_dist", sheet("Spring 2011") cellrange(A3:AK294) clear
...
save "/${raw}/Pre 2014/Dist2011", replace


//// School level data files
import excel "/${raw}/Pre 2014/IN_OriginalData_2007-2015_mat_ela_sch", sheet("Spring 2011") cellrange(A3:AM1544) clear
...
save "/${raw}/Pre 2014/School2011", replace


//append all data
append using "/${raw}/Pre 2014/Dist2011.dta"
append using "/${raw}/Pre 2014/State2011.dta"

save "/${raw}/Pre 2014/IN_2011_appended.dta", replace
...
merge m:1 State_leaid using "/${NCES}/NCES_2010_District.dta"
...
merge m:1 State_leaid seasch using "/${NCES}/NCES_2010_School.dta"
...
save "${output}/IN_AssmtData_2011.dta", replace

export delimited using "${output}/csv/IN_AssmtData_2011.csv", replace
