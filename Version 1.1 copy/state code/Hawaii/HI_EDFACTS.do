...
* egen StateStudentSubGroup_TotalTested = total(nStudentSubGroup_TotalTested), by(StudentSubGroup GradeLevel Subject)
save "`Temp'/`year'_`subject'_`data'_`dl'", replace
clear
}
}
