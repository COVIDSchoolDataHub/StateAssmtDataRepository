...
merge m:1 seasch NCESDistrictID using "${NCES}/NCES_2014_School.dta", force update
...
gen DataLevel = 1
save "${raw}/AZ_AssmtData_2014_State.dta", replace
restore

merge m:1 DataLevel StudentSubGroup GradeLevel Subject using "${raw}/AZ_AssmtData_2014_State.dta"
