...
//
// replace RCDTS = subinstr(RCDTS, "0","",50)
//
...
//
// // use "${output}/IL_AssmtData_2021_sci_AvgScaleScore.dta", clear
//
// *** Sci Participation
//
...
// *gen StateAssignedDistID = substr(StateAssignedSchID,1,11)
//
// merge 1:1 DataLevel StateAssignedSchID SchName GradeLevel StudentSubGroup using "${output}/IL_AssmtData_2021_sci_AvgScaleScore.dta"
// drop _merge  
//
// //merge 1:1 DataLevel StateAssignedDistID SchName GradeLevel StudentSubGroup using "${output}/IL_AssmtData_2021_sci_AvgScaleScore.dta" // CHANGED HERE USED TO BE DIST
// // drop _merge 
// // CODE NOT WORKIGN HERE
//
// replace AvgScaleScore = "--" if AvgScaleScore == ""
//
// merge 1:1 DataLevel StateAssignedSchID SchName GradeLevel StudentSubGroup using "${output}/IL_AssmtData_2021_sci_Participation.dta"
// drop if _merge == 2
// drop _merge
//
...
rename FZ Lev2_percentela3mig
rename GA Lev3_percentela3mig
rename GB Lev4_percentela3mig
rename GC Lev5_percentela3mig
...
export delimited using "${output}/csv/IL_AssmtData_2021_1.csv", replace
