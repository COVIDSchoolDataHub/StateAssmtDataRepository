...
foreach a of local level{
	tostring Lev`a'_percent2, format("%9.2g") replace force
...
save "${output}/OK_AssmtData_2022.dta", replace

export delimited using "${output}/csv/OK_AssmtData_2022.csv", replace
