...
drop if schoolyear != "2014-2015"

gen StudentGroup = "All Students"
gen StudentSubGroup = "All Students"

save "${output}/VA_2015_base.dta", replace


////	Import disaggregate gender data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${output}/VA_2015_gender.dta", replace


////	Import disaggregate language proficiency data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL Status"

save "${output}/VA_2015_language.dta", replace


////	Import disaggregate race data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "RaceEth"

save "${output}/VA_2015_race.dta", replace


//// Import disaggregate economic status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_econ.csv", varnames(1) clear
...
save "${output}/VA_2015_econ.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_migrant.csv", varnames(1) clear
...
save "${output}/VA_2015_migrant.dta", replace


//// Import disaggregate homeless status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_homeless.csv", varnames(1) clear
...
save "${output}/VA_2015_homeless.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_military.csv", varnames(1) clear
...
save "${output}/VA_2015_military.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_foster.csv", varnames(1) clear
...
save "${output}/VA_2015_foster.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2015_all_disabled.csv", varnames(1) clear
...
save "${output}/VA_2015_disabled.dta", replace


////	Append aggregate and disaggregate 

use "${output}/VA_2015_base.dta", clear

append using "${output}/VA_2015_gender.dta"
append using "${output}/VA_2015_language.dta"
append using "${output}/VA_2015_race.dta"
append using "${output}/VA_2015_econ.dta"
append using "${output}/VA_2015_migrant.dta"
append using "${output}/VA_2015_homeless.dta"
append using "${output}/VA_2015_military.dta"
append using "${output}/VA_2015_foster.dta"
append using "${output}/VA_2015_disabled.dta"
...
save "${output}/VA_AssmtData_2015.dta", replace

export delimited using "${output}/csv/VA_AssmtData_2015.csv", replace
