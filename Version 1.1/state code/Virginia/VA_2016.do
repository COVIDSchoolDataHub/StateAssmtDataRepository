...
save "${output}/VA_2016_base.dta", replace


////	Import disaggregate gender data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${output}/VA_2016_gender.dta", replace


////	Import disaggregate language proficiency data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL Status"

save "${output}/VA_2016_language.dta", replace


////	Import disaggregate race data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "RaceEth"

save "${output}/VA_2016_race.dta", replace


//// Import disaggregate economic status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_econ.csv", varnames(1) clear
...
save "${output}/VA_2016_econ.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_migrant.csv", varnames(1) clear
...
save "${output}/VA_2016_migrant.dta", replace


//// Import disaggregate homeless status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_homeless.csv", varnames(1) clear
...
save "${output}/VA_2016_homeless.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_military.csv", varnames(1) clear
...
save "${output}/VA_2016_military.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_foster.csv", varnames(1) clear
...
save "${output}/VA_2016_foster.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2016_all_disabled.csv", varnames(1) clear
...
save "${output}/VA_2016_disabled.dta", replace


////	Append aggregate and disaggregate 

use "${output}/VA_2016_base.dta", clear

append using "${output}/VA_2016_gender.dta"
append using "${output}/VA_2016_language.dta"
append using "${output}/VA_2016_race.dta"
append using "${output}/VA_2016_econ.dta"
append using "${output}/VA_2016_migrant.dta"
append using "${output}/VA_2016_homeless.dta"
append using "${output}/VA_2016_military.dta"
append using "${output}/VA_2016_foster.dta"
append using "${output}/VA_2016_disabled.dta"
...
save "${output}/VA_AssmtData_2016.dta", replace

export delimited using "${output}/csv/VA_AssmtData_2016.csv", replace
