...
save "$NCES/Cleaned NCES Data/NCES_2016_District_NE.dta", replace

use "$NCES/NCES School Files, Fall 1997-Fall 2021/NCES_2015_School.dta", clear
drop if state_location != "NE"
save "$NCES/Cleaned NCES Data/NCES_2016_School_NE.dta", replace

//Merge NCES Data
use "$data/NE_AssmtData_2016.dta", clear
merge m:1 state_leaid using "$NCES/Cleaned NCES Data/NCES_2016_District_NE.dta"
drop if _merge == 2

merge m:1 seasch state_leaid using "$NCES/Cleaned NCES Data/NCES_2016_School_NE.dta", gen (merge2)
drop if merge2 == 2
save "$data/NE_AssmtData_2016.dta", replace
...
//Student Counts
merge 1:1 NCESDistrictID DistName NCESSchoolID SchName Subject GradeLevel StudentSubGroup using "$counts/NE_edfactscount2016.dta"
drop if _merge == 2
...
save "$data/NE_AssmtData_2016.dta", replace
export delimited "$data/NE_AssmtData_2016", replace
clear
