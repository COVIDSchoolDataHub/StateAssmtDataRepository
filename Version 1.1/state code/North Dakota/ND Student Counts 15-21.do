...
save "$counts/ND_edfactscount`year'.dta", replace
...
replace CATEGORY = "English Learner" if CATEGORY == "LEP"
rename CATEGORY StudentSubGroup
save "$counts/ND_edfactscount`year'mathdistrict.dta", replace
...
replace CATEGORY = "English Learner" if CATEGORY == "LEP"
rename CATEGORY StudentSubGroup
save "$counts/ND_edfactscount`year'elaschool.dta", replace
...
replace CATEGORY = "English Learner" if CATEGORY == "LEP"
rename CATEGORY StudentSubGroup
save "$counts/ND_edfactscount`year'eladistrict.dta", replace

use "$counts/ND_edfactscount`year'.dta", clear
append using "$counts/ND_edfactscount`year'mathdistrict.dta" "$counts/ND_edfactscount`year'elaschool.dta" "$counts/ND_edfactscount`year'eladistrict.dta"
save "$counts/ND_edfactscount`year'.dta", replace
}
