...
use "${input}/WA_AssmtData_2015_all.dta", clear
...
save "${output}/WA_BIE_AssmtData_2015.dta", replace

export delimited using "${output}/csv/WA_BIE_AssmtData_2015.csv", replace
