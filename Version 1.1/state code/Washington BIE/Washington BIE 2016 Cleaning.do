...
use "${input}/WA_AssmtData_2016_all.dta", clear
...
save "${output}/WA_BIE_AssmtData_2016.dta", replace

export delimited using "${output}/csv/WA_BIE_AssmtData_2016.csv", replace
