...
forvalues i = 3/8 {
	import sas using "$original_files/TX_OriginalData_2018_G0`i'_State.sas7bdat", clear
...
forvalues i = 3/8 {
	import sas using "$original_files/TX_OriginalData_2018_G0`i'_District.sas7bdat", clear
...
forvalues i = 3/8 {
	import sas using "$original_files/TX_OriginalData_2018_G0`i'_School.sas7bdat", clear
