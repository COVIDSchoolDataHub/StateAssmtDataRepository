...
// State Level
import excel "$original_files/PA_OriginalData_2018_all_State.xlsx", sheet("State") cellrange(A5:I39) firstrow clear
...
save "$temp_files/PA_2018_State.dta", replace

// School Level
import excel "$original_files/PA_OriginalData_2018_all_School.xlsx", sheet("2018 PSSA Grades 3 through 8") cellrange(A5:M48663) firstrow clear
...
save "$temp_files/PA_2018_School.dta", replace

// Merging
clear
append using "$temp_files/PA_2018_State.dta" "$temp_files/PA_2018_School.dta"
...
merge 1:m seasch using "${output_files}/PA_AssmtData_2018.dta", keep(match using) nogenerate
...
merge 1:m ncesdistrictid using "${output_files}/PA_AssmtData_2018.dta", keep(match using) nogenerate
