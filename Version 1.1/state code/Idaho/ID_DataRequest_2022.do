...
// 2021-2022
/*
import excel "$original_files/ID_OriginalData_2022.xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2022_state.dta", replace

import excel "$original_files/ID_OriginalData_2022.xlsx", sheet("Districts") firstrow clear
gen DataLevel = "District"
save "${temp_files}/ID_AssmtData_2022_district.dta", replace

import excel "$original_files/ID_OriginalData_2022.xlsx", sheet("Schools") firstrow clear
