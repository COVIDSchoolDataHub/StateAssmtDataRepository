...
use "${raw}/ELA & Math/Grade 3 2021.dta", clear
gen GradeLevel = "G03"

foreach a of numlist 4/8 {
	append using "${raw}/ELA & Math/Grade `a' 2021.dta"
	replace GradeLevel = "G0`a'" if GradeLevel == ""
}

append using "${raw}/Sci/Grade 5 2021.dta"
replace GradeLevel = "G05" if GradeLevel == ""
append using "${raw}/Sci/Grade 8 2021.dta"
...
merge m:1 State_leaid using "${NCES}/NCES_2020_District.dta", update
...
export delimited using "${output}/csv/NV_AssmtData_2021.csv", replace
