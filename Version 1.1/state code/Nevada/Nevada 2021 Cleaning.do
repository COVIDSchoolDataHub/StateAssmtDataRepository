...
use "${output}/NV_AssmtData_2021_ela.dta", clear
...
save "${output}/NV_AssmtData_2021_elaappend.dta", replace

use "${output}/NV_AssmtData_2021_math.dta", clear
...
save "${output}/NV_AssmtData_2021_mathappend.dta", replace

use "${output}/NV_AssmtData_2021_sci.dta", clear
...
append using "${output}/NV_AssmtData_2021_elaappend.dta"
append using "${output}/NV_AssmtData_2021_mathappend.dta"
