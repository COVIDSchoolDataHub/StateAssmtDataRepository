...
import delimited "$original_files/MN_OriginalData_2018_mat.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${temp_files}/MN_AssmtData_2018_mat.dta", replace

import delimited "$original_files/MN_OriginalData_2018_rea.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${temp_files}/MN_AssmtData_2018_rea.dta", replace

import delimited "$original_files/MN_OriginalData_2018_sci.tab", clear
drop schoolcountynumber
drop districtcountynumber
...
save "${temp_files}/MN_AssmtData_2018_sci.dta", replace

clear

append using "${temp_files}/MN_AssmtData_2018_mat.dta" "${temp_files}/MN_AssmtData_2018_rea.dta" "${temp_files}/MN_AssmtData_2018_sci.dta"
...
save "${output_files}/MN_AssmtData_2018.dta", replace
...
merge 1:m seasch using "${output_files}/MN_AssmtData_2018.dta", keep(match using) nogenerate
...
merge 1:m state_leaid using "${output_files}/MN_AssmtData_2018.dta", keep(match using) nogenerate
...
save "${output_files}/MN_AssmtData_2018.dta", replace
export delimited using "$output_files/MN_AssmtData_2018.csv", replace
