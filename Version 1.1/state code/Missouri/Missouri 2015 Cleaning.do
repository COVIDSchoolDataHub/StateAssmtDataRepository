...
use "${output}/MO_AssmtData_2015-2017_state.dta", clear
append using "${output}/MO_AssmtData_2015-2017_district.dta"
append using "${output}/MO_AssmtData_2015-2017_school.dta"
...
save "${output}/MO_AssmtData_2015.dta", replace

export delimited using "${output}/csv/MO_AssmtData_2015.csv", replace
