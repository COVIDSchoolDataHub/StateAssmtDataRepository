...
merge m:m DistName using "${nces}/1_NCES_2009_District_With_Extra_Districts", force
...
merge m:m seasch1 using "${nces}/1_NCES_2009_School.dta", force
...
export delimited "${output}/CA_AssmtData_2010.csv", replace 
