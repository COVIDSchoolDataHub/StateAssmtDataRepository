...
//NCES Merging
merge m:1 State_leaid using "${nces}/1_NCES_2014_District.dta"
...
merge m:1 seasch1 using "${nces}/1_NCES_2014_School.dta", force
...
replace StateAssignedDistID = "19982" if StateAssignedDistID == "0119982"
