...
merge m:1 State_leaid using "${NCES}/NCES_2016_District_KS.dta"
...
merge m:1 seasch using "${NCES}/NCES_2016_School_KS.dta"
...
merge m:1 DataLevel NCESDistrictID StudentGroup StudentSubGroup GradeLevel Subject using "${EDFacts}/2017/edfactspart2017districtkansas.dta"
replace ParticipationRate = Participation if _merge == 3
drop if _merge == 2
drop stnam _merge Participation

merge m:1 DataLevel NCESSchoolID StudentGroup StudentSubGroup GradeLevel Subject using "${EDFacts}/2017/edfactspart2017schoolkansas.dta"
replace ParticipationRate = Participation if _merge == 3
drop if _merge == 2
drop stnam schnam _merge Participation

save "${raw}/KS_AssmtData_2017_Gender.dta", replace
restore

append using "${raw}/KS_AssmtData_2017_Gender.dta"
...
export delimited using "${output}/KS_AssmtData_2017.csv", replace
