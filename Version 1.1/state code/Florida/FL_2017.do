...
forvalues i = 3/8 {
	foreach subj in ELA M {
			import excel "$original_files/FL_OriginalData_2017_DistState_`subj'_G0`i'", cellrange(A5) firstrow allstring clear
			gen Subject = "`subj'"
			rename *Level*3* ProficientOrAbove_percent
	save "$temp_files/FL_OriginalData_2017_DistState_`subj'_G0`i'.dta", replace
	}
	
	clear
	append using "$temp_files/FL_OriginalData_2017_DistState_ELA_G0`i'.dta" "$temp_files/FL_OriginalData_2017_DistState_M_G0`i'.dta"
	...
	save "$temp_files/FL_OriginalData_2017_DistState_MELA_G0`i'.dta", replace
	
	clear
		foreach subj in ELA M {
			import excel "$original_files/FL_OriginalData_2017_School_`subj'_G0`i'", cellrange(A5) firstrow allstring clear
			gen Subject = "`subj'"
			rename *Level*3* ProficientOrAbove_percent
	save "$temp_files/FL_OriginalData_2017_School_`subj'_G0`i'.dta", replace
	}
	
	clear
	append using "$temp_files/FL_OriginalData_2017_School_ELA_G0`i'.dta" "$temp_files/FL_OriginalData_2017_School_M_G0`i'.dta"
	...
	save "$temp_files/FL_OriginalData_2017_School_MELA_G0`i'.dta", replace
	
	clear
	append using "$temp_files/FL_OriginalData_2017_DistState_MELA_G0`i'.dta" "$temp_files/FL_OriginalData_2017_School_MELA_G0`i'.dta"
	save "$temp_files/FL_OriginalData_2017_All_MELA_G0`i'.dta", replace
}
...
clear
append using "$temp_files/FL_OriginalData_2017_All_MELA_G03.dta" "$temp_files/FL_OriginalData_2017_All_MELA_G04.dta" "$temp_files/FL_OriginalData_2017_All_MELA_G05.dta" "$temp_files/FL_OriginalData_2017_All_MELA_G06.dta" "$temp_files/FL_OriginalData_2017_All_MELA_G07.dta" "$temp_files/FL_OriginalData_2017_All_MELA_G08.dta" "$temp_files/FL_OriginalData_2017_All_S_G05.dta" "$temp_files/FL_OriginalData_2017_All_S_G08.dta"
save "$temp_files/FL_OriginalData_2017_All_All_All.dta", replace


use "$temp_files/FL_OriginalData_2017_All_All_All.dta", clear
...
save "$output_files/FL_AssmtData_2017.dta", replace
...
merge 1:m seasch using "${output_files}/FL_AssmtData_2017.dta", keep(match using)
...
merge 1:m state_leaid using "${output_files}/FL_AssmtData_2017.dta", keep(match using) nogenerate
...
save "${output_files}/FL_AssmtData_2017.dta", replace
export delimited using "$output_files/FL_AssmtData_2017.csv", replace
