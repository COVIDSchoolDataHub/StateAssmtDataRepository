...
merge m:m LEA School Subject StudentGroup LEAName SchoolName using  "/Users/meganchen/Desktop/Research/MD_2021_AssmtDataTemp.dta", nogenerate
...
replace StateAssignedSchID = "" if StateAssignedSchID == "All" 
...
replace StudentGroup = "RaceEth" if StudentGroup == "Native Hawaiian or Other Pacific Islander"

replace StudentSubGroup = "Hispanic or Latino" if StudentSubGroup == "Hispanic/Latino of any race"
...
replace SchYear = "2020-21" if SchYear == "2021" || SchYear == "." || SchYear == "Year"
replace ParticipationRate = "--" if ParticipationRate == ""
replace ProficientOrAbove_count= "--" if ProficientOrAbove_count == ""
replace Lev3_percent= "--" if Lev3_percent == ""
...
//drop if ParticipationRate != "--" & DataLevel != 1
