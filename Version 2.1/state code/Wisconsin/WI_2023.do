...
* Notes
	...
	* This do file import WI 2023 (csv) and saves it as dta. 
	* The file is reshaped, cleaned and merged with NCES 2022.
...
import delimited "${Original}/WI_OriginalData_2023_all.csv", varnames(1) delimit(",") case(preserve)
save "${Original_DTA}/WI_OriginalData_2023_all", replace

use "${Original_DTA}/WI_OriginalData_2023_all"
...
// reordering
local varstemp DistName SchName Subject GradeLevel StudentGroup StudentSubGroup ///
	SubGroup_enrollment StudentSubGroup_TotalTested ParticipationRate Suppressed ///
	SuppressedSubGroup Lev0_count PERCENT_OF_GROUP0 Lev1_count PERCENT_OF_GROUP1 ///
	Lev2_count PERCENT_OF_GROUP2 Lev3_count PERCENT_OF_GROUP3 Lev4_count ///
	PERCENT_OF_GROUP4 SchYear StateAssignedDistID StateAssignedSchID ///
	AssmtName AssmtType Lev1_percent Lev2_percent Lev3_percent Lev4_percent
order `varstemp'
...
save "$Temp/WI_2023_wo_suppressed.dta", replace
...
save "$Temp/WI_2023_only_suppressed.dta", replace

// Appending

clear

append using "$Temp/WI_2023_only_suppressed.dta" "$Temp/WI_2023_wo_suppressed.dta"
...
save "$Temp/WI_2023_wo_new2023.dta", replace
...
merge 1:m StateAssignedDistID StateAssignedSchID using "$Temp/WI_2023_wo_new2023.dta", nogenerate
*/
...
*Exporting Output*
save "${Output}/WI_AssmtData_2023.dta", replace
