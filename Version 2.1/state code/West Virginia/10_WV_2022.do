//2021-2022
import excel "$data/WV_OriginalData_2022_ela,math,sci.xlsx", sheet("SY22 School & District") clear
...
use "$NCES_Dist/NCES_2021_District.dta", clear
drop if state_location != "WV"
gen StateAssignedDistID = substr(state_leaid, 4, 6)
replace StateAssignedDistID = substr(StateAssignedDistID, 1,2)
replace StateAssignedDistID = "0" + StateAssignedDistID
...
merge 1:1 DataLevel NCESDistrictID NCESSchoolID StudentSubGroup GradeLevel Subject using "$counts/WV_StateCounts_2022"
drop if _merge == 2
...
//ParticipationRate
merge 1:1 StateAssignedDistID StateAssignedSchID Subject GradeLevel StudentSubGroup using "$data/WV_Participation_2022"
drop _merge
...
save "$output/WV_AssmtData_2022", replace
export delimited "$output/WV_AssmtData_2022", replace
