...
* Notes
	...
	* This do file cleans MN's 2017 data and merges with NCES 2016.
...
import delimited "$Original/MN_OriginalData_2017_mat.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${Temp}/MN_AssmtData_2017_mat.dta", replace

import delimited "$Original/MN_OriginalData_2017_rea.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${Temp}/MN_AssmtData_2017_rea.dta", replace


import excel "$Original/MN_OriginalData_2017_sci.tab.xlsx", sheet("MN_OriginalData_2017_sci.tab") firstrow case(lower) clear
drop schoolcountynumber
drop districtcountynumber
...
save "${Temp}/MN_AssmtData_2017_sci.dta", replace

clear

append using "${Temp}/MN_AssmtData_2017_mat.dta" "${Temp}/MN_AssmtData_2017_rea.dta" "${Temp}/MN_AssmtData_2017_sci.dta"
...
save "${Original_Cleaned}/MN_AssmtData_2017.dta", replace
...
merge 1:m seasch using "${Original_Cleaned}/MN_AssmtData_2017.dta", keep(match using) nogenerate

save "${Temp}/MN_AssmtData_2017.dta", replace
...
merge 1:m state_leaid using "${Temp}/MN_AssmtData_2017.dta", keep(match using) nogenerate
