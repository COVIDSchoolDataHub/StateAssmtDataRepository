...
* Notes
	...
	* This do file cleans MN's 2001 data and merges with NCES 2000. 
...
save "${Original_Cleaned}/MN_AssmtData_2001.dta", replace

// Merging with NCES School Data

use "$NCES_School/NCES_2000_School.dta", clear 
...
merge 1:m seasch using "${Original_Cleaned}/MN_AssmtData_2001.dta", keep(match using) nogenerate

// save "${temp_files}/MN_AssmtData_2001_SchMerged.dta", replace
save "${Temp}/MN_AssmtData_2001.dta", replace

// Merging with NCES District Data

use "$NCES_District/NCES_2000_District.dta", clear 
...
merge 1:m state_leaid using "${Temp}/MN_AssmtData_2001.dta", keep(match using) nogenerate
