...
* File name: DE Cleaning 2018
* Last update: 2/26/2025

*******************************************************
* Notes

	* This do file imports DE 2018 data, renames variables, cleans and saves it as a dta file.
	* NCES 2017 is merged with DE 2018 data. 
...
save "$Original_Cleaned/DE_OriginalData_ela_mat_2018.dta", replace

use "$Original_Cleaned/DE_OriginalData_ela_mat_2018.dta", clear
...
merge m:1 StateAssignedDistID using "$NCES_DE/NCES_2017_District_DE"
drop if _merge == 2
drop _merge

merge m:1 StateAssignedSchID using "$NCES_DE/NCES_2017_School_DE"
drop if _merge == 2
