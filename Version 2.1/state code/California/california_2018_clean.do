...
// 2017-18 School Year 
use "$Original_Cleaned/California_Original_2018", clear
...
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2017_District_CA.dta", gen(DistMerge1)
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2018_District_CA.dta", update gen(DistMerge2)
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2022_District_CA.dta", update gen(DistMerge3)

merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2017_School_CA.dta", gen(SchMerge1)
merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2018_School_CA.dta", update gen(SchMerge2)
...
save "${Output_ND}/CA_AssmtData2018_NoDev", replace //If .dta format needed.
export delimited "${Output_ND}/CA_AssmtData2018_NoDev", replace 
...
save "${Output}/CA_AssmtData_2018", replace
export delimited "${Output}/CA_AssmtData_2018.csv", replace 
* END of california_2018_clean.do
****************************************************
