...
* File name: california_2012_clean
* Last update: 2/18/2025

*******************************************************
* Notes

	* This do file cleans CA's 2012 data and merges with NCES 2009, 2010 and 2022. 
...
use "$Original_Cleaned/California_Original_2012", clear
...
save "${Output_ND}/CA_AssmtData2012_NoDev", replace //If .dta format needed.
export delimited "${Output_ND}/CA_AssmtData2012_NoDev", replace 
...
save "${Output}/CA_AssmtData_2012", replace
export delimited "${Output}/CA_AssmtData_2012.csv", replace 

* END of california_2012_clean.do
****************************************************
