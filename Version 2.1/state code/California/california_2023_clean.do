...
* File name: california_2023_clean
* Last update: 2/18/2025

*******************************************************
* Notes

	* This do file cleans CA's 2023 ELA and Math data and merges with NCES 2020, 2021 and 2022.
...
// 2022-23 School Year 
use "$Original_Cleaned/California_Original_2023", clear
...
save "${Temp}/CA_AssmtData_2023_ela_math_ND", replace 
...
save "${Temp}/CA_AssmtData_2023_ela_math", replace
* END of california_2023_clean.do
****************************************************
