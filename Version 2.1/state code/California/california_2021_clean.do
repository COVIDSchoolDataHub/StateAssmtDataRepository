...
* File name: california_2021_clean
* Last update: 2/18/2025

*******************************************************
* Notes

	* This do file cleans CA's 2021 ELA and Math data and merges with NCES 2020, 2021 and 2022.
...
// 2020-21 School Year 
use "$Original_Cleaned/California_Original_2021", clear
...
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2020_District_CA.dta", gen(DistMerge1)
...
merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2020_School_CA.dta", gen(SchMerge1)
...
drop if DistName == "SBE - Ross Valley Elementary" & NCESDistrictID == "0600006" //Duplicate school with different name but same ID
...
save "${Temp}/CA_AssmtData_2021_ela_math_ND", replace 
...
save "${Temp}/CA_AssmtData_2021_ela_math", replace
* END of california_2021_clean.do
****************************************************
