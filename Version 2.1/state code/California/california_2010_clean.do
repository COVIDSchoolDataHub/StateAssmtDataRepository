...
* File name: california_2010_clean
* Last update: 2/18/2025

*******************************************************
* Notes

	* This do file cleans CA's 2010 data and merges with NCES 2009, 2010 and 2022. 
...
//2009-2010
use "$Original_Cleaned/California_Original_2010", clear
...
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2009_District_CA.dta", gen(DistMerge1)
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2010_District_CA.dta", update gen(DistMerge2)
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2022_District_CA.dta", update gen(DistMerge3)

merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2009_School_CA.dta", gen(SchMerge1)
merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2010_School_CA.dta", update gen(SchMerge2)
...
//Subject (confirmed this is correct 11/4/24)
gen Subject2 = "" 
replace Subject2 = "math" if Subject == 8
replace Subject2 = "ela" if Subject == 7
replace Subject2 = "soc" if Subject == 29
replace Subject2 = "sci" if Subject == 32
...
save "${Output_ND}/CA_AssmtData2010_NoDev", replace //If .dta format needed.
export delimited "${Output_ND}/CA_AssmtData2010_NoDev", replace 
...
save "${Output}/CA_AssmtData_2010", replace
export delimited "${Output}/CA_AssmtData_2010", replace

* END of california_2010_clean.do
****************************************************
