...
* File name: california_2011_clean
* Last update: 2/18/2025

*******************************************************
* Notes

	* This do file cleans CA's 2011 data and merges with NCES 2009, 2010 and 2022. 
...
use "$Original_Cleaned/California_Original_2011", clear
...
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2010_District_CA.dta", gen(DistMerge1)
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2011_District_CA.dta", update gen(DistMerge2)
merge m:1 NCESDistrictID using "$NCES_CA/NCES_2022_District_CA.dta", update gen(DistMerge3)

merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2010_School_CA.dta", gen(SchMerge1)
merge m:1 NCESSchoolID using "${NCES_CA}/NCES_2011_School_CA.dta", update gen(SchMerge2)
...
save "${Output_ND}/CA_AssmtData2011_NoDev", replace //If .dta format needed.
export delimited "${Output_ND}/CA_AssmtData2011_NoDev", replace 
...
save "${Output}/CA_AssmtData_2011", replace
export delimited "${Output}/CA_AssmtData_2011", replace

* END of california_2011_clean.do
****************************************************
