...
* File name: Nevada 2018 Cleaning
* Last update: 2/28/2025

*******************************************************
* Notes

	* This do file first appends multiple NV 2018 dta files.
	* The combined files are then cleaned and merged with NCES 2017.
...
use "${Original}/ELA & Math/Grade 3 2018.dta", clear
gen GradeLevel = "G03"

foreach a of numlist 4/8 {
	append using "${Original}/ELA & Math/Grade `a' 2018.dta"
	replace GradeLevel = "G0`a'" if GradeLevel == ""
}

append using "${Original}/Sci/Grade 5 2018.dta"
replace GradeLevel = "G05" if GradeLevel == ""
append using "${Original}/Sci/Grade 8 2018.dta"
...
save "${Temp}/NV_AssmtData_2018_Breakpoint.dta", replace
*******************************************************
**Derivations***
*******************************************************
...
merge m:1 State_leaid using "${NCES_NV}/NCES_2017_District_NV.dta"
...
merge m:1 State_leaid using "${NCES_NV}/NCES_2017_District_NV.dta", update
...
merge m:1 seasch using "${NCES_NV}/NCES_2017_School_NV.dta"
...
export delimited using "${Output}/NV_AssmtData_2018.csv", replace
...
use "${Temp}/NV_AssmtData_2018_Breakpoint.dta", clear
...
save "${Output_ND}/NV_AssmtData_2018_ND", replace
export delimited "${Output_ND}/NV_AssmtData_2018_ND", replace
* END of Nevada 2018 Cleaning.do
****************************************************
