...
* File name: Nevada 2016 Cleaning
* Last update: 2/27/2025

*******************************************************
* Notes

	* This do file first appends multiple NV 2016 dta files.
	* The combined files are then cleaned and merged with NCES 2015.
...
use "${Original}/ELA & Math/Grade 3 2016.dta", clear
gen GradeLevel = "G03"

foreach a of numlist 4/8 {
	append using "${Original}/ELA & Math/Grade `a' 2016.dta"
...
save "${Temp}/NV_AssmtData_2016_Breakpoint.dta", replace
*******************************************************
**Derivations***
*******************************************************
...
merge m:1 State_leaid using "${NCES_NV}/NCES_2015_District_NV.dta"
...
merge m:1 seasch using "${NCES_NV}/NCES_2015_School_NV.dta"
...
export delimited using "${Output}/NV_AssmtData_2016.csv", replace
...
use "${Temp}/NV_AssmtData_2016_Breakpoint.dta", clear
...
save "${Output_ND}/NV_AssmtData_2016_ND", replace
export delimited "${Output_ND}/NV_AssmtData_2016_ND", replace
* END of Nevada 2016 Cleaning.do
****************************************************
