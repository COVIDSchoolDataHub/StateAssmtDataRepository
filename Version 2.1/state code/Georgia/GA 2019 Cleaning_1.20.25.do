...
save "$GAdata/GA_OriginalData_2019.dta", replace
import delimited "$GAdata/GA_OriginalData_2019_G38_all.csv", clear
append using "$GAdata/GA_OriginalData_2019.dta"
