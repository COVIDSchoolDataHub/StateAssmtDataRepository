...
save "$GAdata/GA_OriginalData_2022.dta", replace
import delimited "$GAdata/GA_OriginalData_2022_G38_all.csv", clear
tostring num_tested_cnt, replace
append using "$GAdata/GA_OriginalData_2022.dta"
