...
save "$GAdata/GA_OriginalData_2016.dta", replace
import delimited "$GAdata/GA_OriginalData_2016_G38_all.csv", clear
append using "$GAdata/GA_OriginalData_2016.dta"
