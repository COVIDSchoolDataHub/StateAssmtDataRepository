...
foreach s in ela math sci {
	...
	save "${Original}/KY_EFParticipation_2022_`s'.dta", replace
}

use "${Original}/KY_EFParticipation_2022_ela.dta"
append using "${Original}/KY_EFParticipation_2022_math.dta" "${Original}/KY_EFParticipation_2022_sci.dta"
...
save "${Original}/KY_EFParticipation_2022", replace

//Merging with 2022
use "${Output}/KY_AssmtData_2022", clear

destring NCESDistrictID, replace
destring NCESSchoolID, replace

//Merging
merge 1:1 NCESDistrictID NCESSchoolID GradeLevel Subject StudentSubGroup using "${Original}/KY_EFParticipation_2022"
drop if _merge ==2
