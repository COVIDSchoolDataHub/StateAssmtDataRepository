...
* File name: 02_WY_Cleaning_19_24
* Last update: 03/01/2025

*******************************************************
* Notes

	* This do file cleans WY's yearly data from 2019 through 2024 and merges with NCES.
...
forvalues fall = 18/23{
	...
	*Unmerged Schools & Districts 2024
	if `spring' == 24{
		...
		replace DistLocale = "Rural, remote" if DistName == "Prairie View Community School"
		...
		replace DistLocale = "Suburb, small" if DistName == "Wyoming Classical Academy"
