...
//2024 Cleaning
import excel "$Original/HI_OriginalData_2024", clear sheet("STATE") cellrange(A6)
rename A GradeLevel
...
drop if inlist(GradeLevel, "G011", "All Grades")

reshape long StudentSubGroup_TotalTested ProficientOrAbove_count ProficientOrAbove_percent, i(GradeLevel) j(Subject) string
...
save "$Cleaned/HI_State_2024.dta", replace

//2022 & 2023
import delimited "$Cleaned/HI_AssmtData_2022.csv", delimiter(",") stringcols(9, 11, 17/47) case(preserve) clear
save "$Cleaned/HI_AssmtData_2022.dta", replace

import delimited "$Cleaned/HI_AssmtData_2023.csv", delimiter(",") stringcols(9, 11, 17/47) case(preserve) clear
append using "$Cleaned/HI_AssmtData_2022.dta"
...
append using "$Cleaned/HI_State_2024.dta"
...
save "$Cleaned/HI_ED_Data_22_24", replace
export delimited "$Cleaned/HI_ED_Data_22_24.csv", replace
