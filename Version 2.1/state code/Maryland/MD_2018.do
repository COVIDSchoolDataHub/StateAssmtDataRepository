...
* Notes
	...
	* This do file imports 2018 *.csv MD data and saves it as a *.dta.
	...
	* The usual and non-derivation outputs are created for 2018.
...
save "${Original_DTA}/MD_OriginalData_2018", replace
...
merge m:1 State_leaid using "${NCES_MD}/NCES_2017_District_MD", keep(match master) nogen
merge m:1 seasch using "${NCES_MD}/NCES_2017_School_MD", keep(match master) nogen
...
*******************************************************
save "$Temp/MD_2018_Breakpoint",replace
...
*******************************************************
use "$Temp/MD_2018_Breakpoint",clear
...
save "$Output_ND/MD_AssmtData_2018_ND.dta" , replace
export delimited "$Output_ND/MD_AssmtData_2018_ND", replace	
* END of MD_2018.do
****************************************************
