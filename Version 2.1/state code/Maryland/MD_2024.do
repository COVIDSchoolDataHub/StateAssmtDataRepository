...
* Notes
	...
	* This do file imports 2024 *.csv MD data and saves it as a *.dta.
	* The files are cleaned and variables are renamed.
	* NCES 2022 is merged. 
	* As of the last update, the latest NCES is 2022. 
	...
	* Tempory (with derivations) and non-derivation outputs are created for 2024.
...
use "`temp1'"
save "${Original_DTA}/MD_OriginalData_2024", replace
...
//[Note: 3/14/25 - This was originally commented, leaving as is.]
/* 
//Fixing Unmerged
...
*******************************************************
save "$Temp/MD_2024_Breakpoint",replace
...
*******************************************************
use "$Temp/MD_2024_Breakpoint",clear
...
save "$Output_ND/MD_AssmtData_2024_ND.dta" , replace
export delimited "$Output_ND/MD_AssmtData_2024_ND", replace	
* END of MD_2024.do
****************************************************
