...
* File name: Michigan 2022 Cleaning
* Last update: 03/06/2025

*******************************************************
* Notes

	* This do file uses 2022 MI *.dta files
...
use "${Original_DTA}/MI_AssmtData_2022_all.dta", clear
...
merge m:1 State_leaid using "${NCES_MI}/NCES_2021_District_MI.dta"
...
merge m:1 seasch using "${NCES_MI}/NCES_2021_School_MI.dta"
...
*******************************************************
save "$Temp/MI_2022_Breakpoint",replace
...
******************************
*Exporting Temp Output. This will be combined with ED Data Express data in MI_EDFactsParticipation_2022.
******************************
save "${Temp}/MI_AssmtData_2022", replace

******************************
// Creating the non-derivation output
******************************
*Restoring the breakpoint
use "$Temp/MI_2022_Breakpoint", clear
...
save "${Output_ND}/MI_AssmtData_2022_ND", replace
export delimited "${Output_ND}/MI_AssmtData_2022_ND", replace
*End of Michigan 2022 Cleaning.do
****************************************************
