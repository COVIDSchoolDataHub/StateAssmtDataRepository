...
* File name: Michigan 2017 Cleaning
* Last update: 03/06/2025

*******************************************************
* Notes

	* This do file uses 2017 MI *.dta files
	* These files are renamed, cleaned and reshaped.
	* NCES 2016, 2017 (schools only), and 2021 (schools only) are merged.
...
use "${Original_DTA}/MI_AssmtData_2017_all.dta", clear
...
merge m:1 State_leaid using "${NCES_MI}/NCES_2016_District_MI.dta"
...
merge m:1 seasch using "${NCES_MI}/NCES_2016_School_MI.dta"
...
*******************************************************
save "$Temp/MI_2017_Breakpoint",replace
...
******************************
save "${Temp}/MI_AssmtData_2017", replace

******************************
// Creating the non-derivation output
******************************
*Restoring the breakpoint
use "$Temp/MI_2017_Breakpoint", clear
...
save "${Output_ND}/MI_AssmtData_2017_ND", replace
export delimited "${Output_ND}/MI_AssmtData_2017_ND", replace
*End of Michigan 2017 Cleaning.do
****************************************************
