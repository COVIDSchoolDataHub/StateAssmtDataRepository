...
* Notes
	...
	* This do file cleans TX's 2012 data and merges with NCES_2011.
...
use "${original_reduced}/TX_Temp_2012_All_All.dta", clear
...
save "$temp_files/TX_AssmtData_2012.dta", replace
...
*save "${output_ND}/TX_AssmtData_2012_NoDev", replace //If .dta format needed. 
*export delimited "${output_ND}/TX_AssmtData_2012_NoDev", replace
