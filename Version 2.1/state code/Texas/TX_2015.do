...
* Notes
	...
	* This do file cleans TX's 2015 data and merges with NCES_2014.
...
*** Cleaning ***
/////////////////////////////////////////
use "${original_reduced}/TX_Temp_2015_All_All.dta", clear
...
*Generating empty Level 4 and 5 counts and percentages. since TX had only 3 Levels in 2015. 
gen Lev4_count = ""
gen Lev4_percent = ""
gen Lev5_count = ""
gen Lev5_percent = ""
...
save "$temp_files/TX_AssmtData_2015.dta", replace
...
merge 1:m state_leaid using "${temp_files}/TX_AssmtData_2015.dta", keep(match using) nogenerate
...
merge 1:m seasch using "${temp_files}/TX_AssmtData_2015.dta", keep(match using) nogenerate
...
*save "${output_ND}/TX_AssmtData_2015_NoDev", replace //If .dta format needed. 
*export delimited "${output_ND}/TX_AssmtData_2015_NoDev", replace

*Exporting into the usual output file* 
*save "${output_files}/TX_AssmtData_2015.dta", replace //If .dta format needed. 
