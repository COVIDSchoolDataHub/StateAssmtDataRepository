...
* Notes
	...
	* This do file first cleans ID's 2022 data. isolates 
...
import excel "$orig_files_DR_112723/2021-2022 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
	gen DataLevel = "State"
	save "${temp_files}/ID_AssmtData_2022_state.dta", replace

import excel "$orig_files_DR_112723/2021-2022 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
	gen DataLevel = "District"
	save "${temp_files}/ID_AssmtData_2022_district.dta", replace

import excel "$orig_files_DR_112723/2021-2022 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
	gen DataLevel = "School"
	save "${temp_files}/ID_AssmtData_2022_school.dta", replace

clear

append using "${temp_files}/ID_AssmtData_2022_state.dta" "${temp_files}/ID_AssmtData_2022_district.dta" "${temp_files}/ID_AssmtData_2022_school.dta"

save "${temp_files}/ID_AssmtData_2022_all.dta", replace
...
merge 1:m seasch using "${output_files}/ID_AssmtData_2022.dta", keep(match using) nogenerate
save "${output_files}/ID_AssmtData_2022.dta", replace
...
merge 1:m state_leaid using "${output_files}/ID_AssmtData_2022.dta", keep(match using) nogenerate
