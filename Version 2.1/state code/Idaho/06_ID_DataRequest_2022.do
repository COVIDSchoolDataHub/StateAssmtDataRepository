...
* File name: 06_ID_DataRequest_2022
* Last update: 2/26/2025

*******************************************************
* Notes

	* This do file first imports and cleans ID's 2022 data. 
	* Then this file merges ID's data with NCES_2021
...
import excel "$Original/2021-2022 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
	gen DataLevel = "State"
	save "${Temp}/ID_AssmtData_2022_state.dta", replace

import excel "$Original/2021-2022 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
	gen DataLevel = "District"
	save "${Temp}/ID_AssmtData_2022_district.dta", replace

import excel "$Original/2021-2022 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
	gen DataLevel = "School"
	save "${Temp}/ID_AssmtData_2022_school.dta", replace

clear

append using "${Temp}/ID_AssmtData_2022_state.dta" "${Temp}/ID_AssmtData_2022_district.dta" "${Temp}/ID_AssmtData_2022_school.dta"

save "${Temp}/ID_AssmtData_2022_all.dta", replace

///////////////////////////////
// Cleaning ID 2022 file
///////////////////////////////
...
save "${Temp}/ID_AssmtData_2022_Breakpoint.dta", replace
...
save "${Original_Cleaned}/ID_AssmtData_2022.dta", replace
...
merge 1:m seasch using "${Original_Cleaned}/ID_AssmtData_2022.dta", keep(match using) nogenerate
save "${Temp}/ID_AssmtData_2022.dta", replace
...
merge 1:m state_leaid using "${Temp}/ID_AssmtData_2022.dta", keep(match using) nogenerate
...
*Exporting Output*
save "${Output}/ID_AssmtData_2022.dta", replace
export delimited using "$Output/ID_AssmtData_2022.csv", replace
...
use "${Temp}/ID_AssmtData_2022_Breakpoint.dta", clear
...
// Saving transformed data
save "${Original_Cleaned}/ID_AssmtData_2022_ND.dta", replace
...
merge 1:m seasch using "${Original_Cleaned}/ID_AssmtData_2022_ND.dta", keep(match using) nogenerate
save "${Temp}/ID_AssmtData_2022_ND.dta", replace
...
merge 1:m state_leaid using "${Temp}/ID_AssmtData_2022_ND.dta", keep(match using) nogenerate
...
save "${Output_ND}/ID_AssmtData_2022_ND", replace
export delimited "${Output_ND}/ID_AssmtData_2022_ND", replace

* END of 06_ID_DataRequest_2022.do
****************************************************
