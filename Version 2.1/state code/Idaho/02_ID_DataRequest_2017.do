...
* Notes
	...
	* This do file first cleans ID's 2017 data. isolates 
...
import excel "$orig_files_DR_112723/2016-2017 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
	gen DataLevel = "State"
	save "${temp_files}/ID_AssmtData_2017_state.dta", replace

import excel "$orig_files_DR_112723/2016-2017 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
	gen DataLevel = "District"
	save "${temp_files}/ID_AssmtData_2017_district.dta", replace

import excel "$orig_files_DR_112723/2016-2017 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
	gen DataLevel = "School"
	save "${temp_files}/ID_AssmtData_2017_school.dta", replace

clear

append using "${temp_files}/ID_AssmtData_2017_state.dta" "${temp_files}/ID_AssmtData_2017_district.dta" "${temp_files}/ID_AssmtData_2017_school.dta"

save "${temp_files}/ID_AssmtData_2017_all.dta", replace
...
save "${output_files}/ID_AssmtData_2017.dta", replace
...
use "$NCES_files/NCES School Files, Fall 1997-Fall 2022/NCES_2016_School.dta", clear 
...
merge 1:m seasch using "${output_files}/ID_AssmtData_2017.dta", keep(match using) nogenerate
save "${output_files}/ID_AssmtData_2017.dta", replace
...
merge 1:m state_leaid using "${output_files}/ID_AssmtData_2017.dta", keep(match using) nogenerate
...
*save "${output_files}/ID_AssmtData_2017.dta", replace
export delimited using "$output_files/ID_AssmtData_2017.csv", replace
