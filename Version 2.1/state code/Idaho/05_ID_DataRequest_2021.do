...
* File name: 05_ID_DataRequest_2021
* Last update: 2/26/2025

*******************************************************
* Notes

	* This do file first imports and cleans ID's 2021 data. 
	* Then this file merges ID's data with NCES_2020
...
///////////////////////////////
import excel "$Original/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
	gen DataLevel = "State"
	save "${Temp}/ID_AssmtData_2021_state.dta", replace

import excel "$Original/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
	gen DataLevel = "District"
	save "${Temp}/ID_AssmtData_2021_district.dta", replace

import excel "$Original/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
	gen DataLevel = "School"
	save "${Temp}/ID_AssmtData_2021_school.dta", replace

clear

append using "${Temp}/ID_AssmtData_2021_state.dta" "${Temp}/ID_AssmtData_2021_district.dta" "${Temp}/ID_AssmtData_2021_school.dta"

save "${Temp}/ID_AssmtData_2021_all.dta", replace

///////////////////////////////
// Cleaning ID 2021 file
///////////////////////////////
...
save "${Temp}/ID_AssmtData_2021_Breakpoint.dta", replace
...
save "${Output}/ID_AssmtData_2021.dta", replace
...
merge 1:m seasch using "${Output}/ID_AssmtData_2021.dta", keep(match using) nogenerate
save "${Temp}/ID_AssmtData_2021.dta", replace
...
merge 1:m state_leaid using "${Temp}/ID_AssmtData_2021.dta", keep(match using) nogenerate
...
*Exporting Output*
save "${Output}/ID_AssmtData_2021", replace
export delimited "${Output}/ID_AssmtData_2021", replace
...
use "${Temp}/ID_AssmtData_2021_Breakpoint.dta", clear
...
// Saving transformed data
save "${Output_ND}/ID_AssmtData_2021_ND.dta", replace
...
merge 1:m seasch using "${Output_ND}/ID_AssmtData_2021_ND.dta", keep(match using) nogenerate
save "${Temp}/ID_AssmtData_2021_ND.dta", replace
...
merge 1:m state_leaid using "${Temp}/ID_AssmtData_2021_ND.dta", keep(match using) nogenerate
...
save "${Output_ND}/ID_AssmtData_2021_ND", replace
export delimited "${Output_ND}/ID_AssmtData_2021_ND", replace

* END of 05_ID_DataRequest_2021.do
****************************************************
