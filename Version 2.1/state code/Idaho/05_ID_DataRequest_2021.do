...
* Notes
	...
	* This do file first cleans ID's 2021 data. isolates 
...
import excel "$orig_files_DR_112723/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
	gen DataLevel = "State"
	save "${temp_files}/ID_AssmtData_2021_state.dta", replace

import excel "$orig_files_DR_112723/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
	gen DataLevel = "District"
	save "${temp_files}/ID_AssmtData_2021_district.dta", replace

import excel "$orig_files_DR_112723/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
