...
* File name: OH 2018 Cleaning
* Last update: 03/10/2025

*******************************************************
* Notes

	* This do file uses 2018 OH data. 
...
use "$Original_DTA/OH_OriginalData_2018.dta", clear
...
*******************************************************
save "$Temp/OH_2018_Breakpoint",replace

//Derivation [286,782 changes!]
...
save "$Temp/OH_AssmtData_2018.dta", replace
...
save "$NCES_OH/NCES_2017_District_OH.dta", replace
...
save "$NCES_OH/NCES_2017_School_OH.dta", replace

* Merge Data
use "$Temp/OH_AssmtData_2018.dta", clear

merge m:1 StateAssignedDistID using "$NCES_OH/NCES_2017_District_OH.dta"
drop if _merge == 2
drop _merge

merge m:1 StateAssignedSchID using "$NCES_OH/NCES_2017_School_OH.dta"
...
use "$Temp/OH_2018_Breakpoint", clear
...
save "${Output_ND}/OH_AssmtData_2018_ND", replace
export delimited "${Output_ND}/OH_AssmtData_2018_ND", replace
*End of OH 2018 Cleaning.do
****************************************************
