...
* File name: OH 2022 Cleaning
* Last update: 03/10/2025

*******************************************************
* Notes

	* This do file uses 2022 OH data. 
...
use "$Original_DTA/OH_OriginalData_2022.dta", clear
...
*******************************************************
save "$Temp/OH_2022_Breakpoint",replace

//Derivation [290,976 changes!]
...
save "$Temp/OH_AssmtData_2022.dta", replace
...
save "$NCES_OH/NCES_2021_District_OH.dta", replace
...
save "$NCES_OH/NCES_2021_School_OH.dta", replace

* Merge Data
use "$Temp/OH_AssmtData_2022.dta", clear

merge m:1 StateAssignedDistID using "$NCES_OH/NCES_2021_District_OH.dta"
drop if _merge == 2
drop _merge

merge m:1 StateAssignedSchID using "$NCES_OH/NCES_2021_School_OH.dta"
...
drop if NCESSchoolID == "390443701301" //all data are suppressed because this is a preschool
...
use "$Temp/OH_2022_Breakpoint", clear
...
save "${Output_ND}/OH_AssmtData_2022_ND", replace
export delimited "${Output_ND}/OH_AssmtData_2022_ND", replace
*End of OH 2022 Cleaning.do
****************************************************
