...
* File name: OH 2023 Cleaning
* Last update: 03/11/2025

*******************************************************
* Notes

	* This do file uses 2023 OH data. 
...
use "$Original_DTA/OH_OriginalData_2023.dta", clear

rename school_year SchYear
tostring SchYear, replace
replace SchYear = "2022-23" if SchYear == "2023"
...
*******************************************************
save "$Temp/OH_2023_Breakpoint",replace

//Derivation [287,388 changes made!]
...
save "$Temp/OH_AssmtData_2023.dta", replace
...
* Merge Data
use "$Temp/OH_AssmtData_2023.dta", clear
...
use "$Temp/OH_2023_Breakpoint", clear
...
save "${Output_ND}/OH_AssmtData_2023_ND", replace
export delimited "${Output_ND}/OH_AssmtData_2023_ND", replace
*End of OH 2023 Cleaning.do
****************************************************
