...
* File name: OH 2019 Cleaning
* Last update: 03/10/2025

*******************************************************
* Notes

	* This do file uses 2019 OH data. 
...
use "$Original_DTA/OH_OriginalData_2019.dta", clear
...
*******************************************************
save "$Temp/OH_2019_Breakpoint",replace

//Derivation [285,244 changes!]
...
save "$Temp/OH_AssmtData_2019.dta", replace
...
save "$NCES_OH/NCES_2018_District_OH.dta", replace
...
save "$NCES_OH/NCES_2018_School_OH.dta", replace

* Merge Data
use "$Temp/OH_AssmtData_2019.dta", clear

merge m:1 StateAssignedDistID using "$NCES_OH/NCES_2018_District_OH.dta"
drop if _merge == 2
drop _merge

merge m:1 StateAssignedSchID using "$NCES_OH/NCES_2018_School_OH.dta"
...
use "$Temp/OH_2019_Breakpoint", clear
...
save "${Output_ND}/OH_AssmtData_2019_ND", replace
export delimited "${Output_ND}/OH_AssmtData_2019_ND", replace
*End of OH 2019 Cleaning.do
****************************************************
