...
* File name: OH 2016 Cleaning
* Last update: 03/10/2025

*******************************************************
* Notes

	* This do file uses 2016 OH data. 
...
use "$Original_DTA/OH_OriginalData_2016.dta", clear
...
*******************************************************
save "$Temp/OH_2016_Breakpoint",replace

//Derivation [327,005 changes!]
...
save "$Temp/OH_AssmtData_2016.dta", replace
...
save "$NCES_OH/NCES_2015_District_OH.dta", replace
...
save "$NCES_OH/NCES_2015_School_OH.dta", replace

* Merge Data
use "$Temp/OH_AssmtData_2016.dta", clear

merge m:1 StateAssignedDistID using "$NCES_OH/NCES_2015_District_OH.dta"
drop if _merge == 2
drop _merge

merge m:1 StateAssignedSchID using "$NCES_OH/NCES_2015_School_OH.dta"
...
use "$Temp/OH_2016_Breakpoint", clear
...
save "${Output_ND}/OH_AssmtData_2016_ND", replace
export delimited "${Output_ND}/OH_AssmtData_2016_ND", replace
*End of OH 2016 Cleaning.do
****************************************************
