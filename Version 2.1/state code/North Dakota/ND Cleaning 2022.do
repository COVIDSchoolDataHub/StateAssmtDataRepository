...
* File name: ND Cleaning 2022
* Last update: 03/05/2025

*******************************************************
* Notes

	* This do file imports 2022 Participation Data and the Original Data.
...
import excel "$Original/ND_ParticipationData_2022.xlsx", clear firstrow
duplicates drop
save "$Original_DTA/ND_ParticipationData_2022.dta", replace

import excel "$Original/ND_OriginalData_2022_all.xlsx", clear firstrow
duplicates drop
merge 1:1 InstitutionName InstitutionID Grade Subject AssessmentType Accomodations Subgroup using "$Original_DTA/ND_ParticipationData_2022.dta", gen (mergep)
drop if mergep == 2
...
merge m:1 State_leaid using "$NCES_ND/NCES_2021_District_ND.dta"
drop if _merge == 2
drop _merge

merge m:1 State_leaid seasch using "$NCES_ND/NCES_2021_School_ND.dta", update
drop if _merge == 2
drop _merge
...
*******************************************************
save "$Temp/ND_2022_Breakpoint",replace
...
*Exporting Output.
save "${Output}/ND_AssmtData_2022", replace
export delimited "${Output}/ND_AssmtData_2022", replace

******************************
// Creating the non-derivation output
******************************
*Restoring the breakpoint
use "$Temp/ND_2022_Breakpoint", clear
...
save "${Output_ND}/ND_AssmtData_2022_ND", replace
export delimited "${Output_ND}/ND_AssmtData_2022_ND", replace
*End of ND Cleaning 2022.do
****************************************************
