...
import excel "${path}/Original Data Files/LA_OriginalData_2019.xls", sheet("2019 LEAP SUPPRESSED") cellrange(A3:BG65536) firstrow allstring clear
...
save "${path}/Semi-Processed Data Files/TN_2019_nogroup.dta", replace
...
save "${path}/Semi-Processed Data Files/TN_2019_group.dta", replace
clear
use "${path}/Semi-Processed Data Files/TN_2019_nogroup.dta"
merge m:1 DataLevel StateAssignedDistID StateAssignedSchID Subject GradeLevel using "${path}/Semi-Processed Data Files/TN_2019_group.dta"
drop _merge
