...
import excel "${data}/MO_OriginalData_2023_all_state.xlsx", firstrow clear
save "${data}/MO_OriginalData_2023_all_state.dta", replace
import excel "${data}/MO_OriginalData_2023_all_district.xlsx", firstrow clear
save "${data}/MO_OriginalData_2023_all_district.dta", replace
import excel "${data}/MO_OriginalData_2023_all_school.xlsx", firstrow clear
tostring SCHOOL_CODE, replace
save "${data}/MO_OriginalData_2023_all_school.dta", replace

use "${data}/MO_OriginalData_2023_all_state.dta", clear
append using "${data}/MO_OriginalData_2023_all_district.dta"
append using "${data}/MO_OriginalData_2023_all_school.dta"
...
merge m:1 State_leaid using "${NCES}/NCES_2021_District_MO.dta"
...
merge m:1 seasch using "${NCES}/NCES_2021_School_MO.dta"
...
save "${data}/MO_AssmtData_2023.dta", replace

export delimited using "${data}/MO_AssmtData_2023.csv", replace
