...
merge m:1 State_leaid using "${NCES}/NCES_2013_District.dta", update
...
merge m:1 seasch using "${NCES}/NCES_2013_School.dta", update
...
save "${output}/MO_AssmtData_2013.dta", replace

export delimited using "${output}/csv/MO_AssmtData_2013.csv", replace
