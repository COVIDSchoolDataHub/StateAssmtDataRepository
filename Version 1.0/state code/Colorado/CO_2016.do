...
global disagg "/Users/maggie/Desktop/Colorado/Original Data Files/Original Data Files/CMAS Disaggregate-SubPop Data/2016"
...
import excel "${path}/CO_OriginalData_2016_ela_mat.xlsx", sheet("ELA") cellrange(A5:X6776) firstrow case(lower) clear
...
save "${path}/CO_OriginalData_2016_ela.dta", replace


import excel "${path}/CO_OriginalData_2016_ela_mat.xlsx", sheet("MATH") cellrange(A5:X7937) firstrow case(lower) clear
...
save "${path}/CO_OriginalData_2016_math.dta", replace
...
append using "${path}/CO_OriginalData_2016_ela.dta"
append using "${path}/CO_OriginalData_2016_math.dta"
...
import excel "${disagg}/CO_2016_ELA_gender.xlsx", sheet("Sheet 1") cellrange(A4:X13430) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_ELA_language.xlsx", sheet("Sheet1 1") cellrange(A4:X18849) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_ELA_raceEthnicity.xlsx", sheet("Sheet1 1") cellrange(A4:X28164) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_ELA_FreeReducedLunch.xlsx", sheet("Sheet 1") cellrange(A4:X13238) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_mat_gender.xlsx", sheet("Sheet 1") cellrange(A4:X15545) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_mat_language.xlsx", sheet("Sheet 1") cellrange(A4:X20888) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_mat_raceEthnicity.xlsx", sheet("Sheet 1") cellrange(A4:X31413) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_mat_FreeReducedLunch.xlsx", sheet("Sheet 1") cellrange(A4:X15207) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_sci_gender.xlsx", sheet("Sheet 1") cellrange(A4:V5249) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_sci_language.xlsx", sheet("Sheet 1") cellrange(A4:V7323) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_sci_raceEthnicity.xlsx", sheet("Sheet 1") cellrange(A4:V10959) firstrow case(lower) clear
...
import excel "${disagg}/CO_2016_sci_FreeReducedLunch.xlsx", sheet("Sheet 1") cellrange(A4:V5175) firstrow case(lower) clear
...
append using "${path}/CO_OriginalData_2016_all.dta"
...
export delimited using "${output}/csv/CO_AssmtData_2016.csv", replace
