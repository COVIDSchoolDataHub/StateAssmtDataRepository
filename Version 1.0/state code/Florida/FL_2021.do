...
forvalues i = 3/8 {
	foreach subj in ELA M {
			import excel "$original_files/FL_OriginalData_2021_DistState_`subj'_G0`i'", cellrange(A5) firstrow allstring clear
			gen Subject = "`subj'"
	save "$temp_files/FL_OriginalData_2021_DistState_`subj'_G0`i'.dta", replace
	}
	
	clear
	append using "$temp_files/FL_OriginalData_2021_DistState_ELA_G0`i'.dta" "$temp_files/FL_OriginalData_2021_DistState_M_G0`i'.dta"
	...
	save "$temp_files/FL_OriginalData_2021_DistState_MELA_G0`i'.dta", replace
	
	clear
		foreach subj in ELA M {
			import excel "$original_files/FL_OriginalData_2021_School_`subj'_G0`i'", cellrange(A5) firstrow allstring clear
			gen Subject = "`subj'"
	save "$temp_files/FL_OriginalData_2021_School_`subj'_G0`i'.dta", replace
	}
	
	clear
	append using "$temp_files/FL_OriginalData_2021_School_ELA_G0`i'.dta" "$temp_files/FL_OriginalData_2021_School_M_G0`i'.dta"
	...
	save "$temp_files/FL_OriginalData_2021_School_MELA_G0`i'.dta", replace
	
	clear
	append using "$temp_files/FL_OriginalData_2021_DistState_MELA_G0`i'.dta" "$temp_files/FL_OriginalData_2021_School_MELA_G0`i'.dta"
	save "$temp_files/FL_OriginalData_2021_All_MELA_G0`i'.dta", replace
}

foreach i in 5 8 {
	import excel "$original_files/FL_OriginalData_2021_DistState_S_G0`i'", cellrange(A9) firstrow allstring clear
	...
	save "$temp_files/FL_OriginalData_2021_DistState_S_G0`i'.dta", replace
	
	import excel "$original_files/FL_OriginalData_2021_School_S_G0`i'", cellrange(A9) firstrow allstring clear
	...
	save "$temp_files/FL_OriginalData_2021_School_S_G0`i'.dta", replace
	
	clear
	append using "$temp_files/FL_OriginalData_2021_DistState_S_G0`i'.dta" "$temp_files/FL_OriginalData_2021_School_S_G0`i'.dta"
	gen Subject = "sci"
	save "$temp_files/FL_OriginalData_2021_All_S_G0`i'.dta", replace
}

clear
append using "$temp_files/FL_OriginalData_2021_All_MELA_G03.dta" "$temp_files/FL_OriginalData_2021_All_MELA_G04.dta" "$temp_files/FL_OriginalData_2021_All_MELA_G05.dta" "$temp_files/FL_OriginalData_2021_All_MELA_G06.dta" "$temp_files/FL_OriginalData_2021_All_MELA_G07.dta" "$temp_files/FL_OriginalData_2021_All_MELA_G08.dta" "$temp_files/FL_OriginalData_2021_All_S_G05.dta" "$temp_files/FL_OriginalData_2021_All_S_G08.dta"
save "$temp_files/FL_OriginalData_2021_All_All_All.dta", replace


use "$temp_files/FL_OriginalData_2021_All_All_All.dta", clear
...
// Fixing grade and district numbers
...
save "$output_files/FL_AssmtData_2021.dta", replace
...
merge 1:m seasch using "${output_files}/FL_AssmtData_2021.dta", keep(match using) nogenerate
...
merge 1:m state_leaid using "${output_files}/FL_AssmtData_2021.dta", keep(match using) nogenerate
...
save "${output_files}/FL_AssmtData_2021.dta", replace
export delimited using "$output_files/FL_AssmtData_2021.csv", replace
