...
use "${input}/WA_AssmtData_2019_all.dta", clear
...
keep if SchName == "Lummi Nation School (Closed after 2020-2021 school year)" | SchName == "Paschal Sherman (Closed after 2020-2021 school year)" | SchName == "Wa He Lut Indian School (Closed after 2020-2021 school year)" | SchName == "Chief Leschi Schools(Closed) (Closed after 2020-2021 school year)" | SchName == "Muckleshoot Tribal School (Closed after 2020-2021 school year)" | SchName == "Quileute Tribal School (Closed after 2020-2021 school year)"
...
replace State_leaid = "BI-D10P15" if SchName == "Chief Leschi Schools(Closed) (Closed after 2020-2021 school year)"
...
save "${output}/WA_BIE_AssmtData_2019.dta", replace

export delimited using "${output}/csv/WA_BIE_AssmtData_2019.csv", replace
