...
use "${input}/WA_AssmtData_2021_all.dta", clear
...
save "${output}/WA_BIE_AssmtData_2021.dta", replace

export delimited using "${output}/csv/WA_BIE_AssmtData_2021.csv", replace
