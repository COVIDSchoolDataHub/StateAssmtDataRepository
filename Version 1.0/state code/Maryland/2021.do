...
replace Subject = "math" if Subject == "Mathematics"
replace Subject = "sci" if Subject == "Science"
replace StudentGroup = "Two or more races" if StudentGroup == "Two or More Races"
replace StudentGroup = "Hispanic/Latino of any race" if StudentGroup == "Hispanic/Latino of Any Race" 
...
drop if StudentGroup == "FARMS" || StudentGroup == "ADA/504" || StudentGroup == "Military Connected" || StudentGroup == "Homeless" || StudentGroup == "Foster Care" || StudentGroup == "Title I" || StudentGroup == "Students with Disabilities" || StudentGroup == "Students without Disabilities"
