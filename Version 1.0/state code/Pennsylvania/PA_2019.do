...
// State Level
import excel "$original_files/PA_OriginalData_2019_all_State.xlsx", sheet("State") cellrange(B4:J38) firstrow clear
...
save "$temp_files/PA_2019_State.dta", replace

// School Level
import excel "$original_files/PA_OriginalData_2019_all_School.xlsx", sheet("PSSA website") cellrange(A5:M48136) firstrow clear
...
save "$temp_files/PA_2019_School.dta", replace

// Merging
clear
append using "$temp_files/PA_2019_State.dta" "$temp_files/PA_2019_School.dta"
...
merge 1:m seasch using "${output_files}/PA_AssmtData_2019.dta", keep(match using) nogenerate
...
merge 1:m ncesdistrictid using "${output_files}/PA_AssmtData_2019.dta", keep(match using) nogenerate
