...
merge m:1 NCESSchoolID Subject GradeLevel StudentSubGroup DataLevel using "${edfacts}/UT_edfact_2014_school.dta", update replace

drop if _merge==2

drop _merge

merge m:1 NCESDistrictID Subject GradeLevel StudentSubGroup DataLevel using "${edfacts}/UT_edfact_2014_district.dta", update replace

drop if _merge==2

drop _merge

merge m:1 Subject GradeLevel StudentSubGroup DataLevel using "${edfacts}/UT_edfact_2014_state.dta", update replace
