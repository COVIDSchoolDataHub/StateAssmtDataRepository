...
// 2017-2018
/*
import excel "$original_files/ID_OriginalData_2018.xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2018_state.dta", replace

import excel "$original_files/ID_OriginalData_2018.xlsx", sheet("Districts") firstrow clear
gen DataLevel = "District"
save "${temp_files}/ID_AssmtData_2018_district.dta", replace

import excel "$original_files/ID_OriginalData_2018.xlsx", sheet("Schools") firstrow clear
