...
** 4 things to select all and replace in this review code:

**	1. C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0 				// change to your own path
**	2. Florida - Version 2.0 	// change to the new state name. Be careful with spacing around the hyphen.
**	3. fl_assmtdata  			// change to the new state abbrev  
**	4. fl_allyears 				// change to the new state abbrev  


***************************************
clear
*** 1) Define csv files to include 
cd "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0" // Save path to current folder in a local
...
// This code imports the file variables as string except for NCES IDs (variables 8 and 10)
foreach x of local files {
    di "`x'" // Display file name

	* 2A) Import each file and generate id var (filename without ".csv")
	qui: import delimited "`x'", delimiter("")  stringcols(9, 11, 17/47) case(preserve) clear // <-- Change delimiter() if vars are separated by "," or tab
...
"C:\Users\Clare\Desktop\Zelma V2.0\Florida- Version 2.0\fl_assmtdata_2010.csv.dta"  "C:\Users\Clare\Desktop\Zelma V2.0\Florida- Version 2.0\fl_assmtdata_2011.csv.dta"  "C:\Users\Clare\Desktop\Zelma V2.0\Florida- Version 2.0\fl_assmtdata_2012.csv.dta"  "C:\Users\Clare\Desktop\Zelma V2.0\Florida- Version 2.0\fl_assmtdata_2013.csv.dta"  "C:\Users\Clare\Desktop\Zelma V2.0\Florida- Version 2.0\fl_assmtdata_2014.csv.dta"  
*/


** Append files. Update based on appropriate years for each state. 
clear 
append using  "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2015.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2016.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2017.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2018.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2019.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2021.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2022.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2023.csv.dta" "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_assmtdata_2024.csv.dta", force
...
** Generate file name; this will be used in the review process to identify the relevant files. Do not use SchYear in the even that there are issues with that variable.
split id, p(_)
rename id3 FILE
drop id id1 id2 
...
save "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_allyears.dta", replace empty
...
clear
use "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\fl_allyears.dta"
...
tab FILE if SchYear StateAbbrev=="" // should be no observerations 
...
duplicates drop 
export excel using "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\review\mismatched dist ids.xlsx", firstrow(variables)
restore
...
duplicates drop 
export excel using "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\review\mismatched sch ids.xlsx", firstrow(variables)
restore
...
duplicates drop 
export excel using "C:\Users\Clare\Desktop\Zelma V2.0\Florida - Version 2.0\review\county ids.xlsx", firstrow(variables) replace
restore
...
tab StudentGroup_TotalTested FILE if StudentGroup_TotalTested < "0" 
...
local levpercents "Lev1_percent Lev2_percent Lev3_percent Lev4_percent Lev5_percent Lev6_percent"
...
egen sumoflevcounts = rowtotal(Lev3_n Lev4_n Lev5_n)
...
// add applicable levels below 
egen sumoflevpercents = rowtotal(Lev3_p Lev4_p Lev5_p)
