...
merge m:1 State_leaid using "${NCES}/NCES_2015_District.dta", force
drop if _merge == 2
drop _merge

merge m:1 seasch NCESDistrictID using "${NCES}/NCES_2015_School.dta", force
drop if _merge == 2
drop _merge
...
** Append all files 
append using "${output}/AZ_AssmtData_school_2016.dta" "${output}/AZ_AssmtData_district_2016.dta"
...
replace DistName = "Fowler Elementary District" if NCESDistrictID == "0403060"
