...
merge m:1 State_leaid using "${NCES}/NCES_2015_District_AZ.dta", force
drop if _merge == 2
drop _merge

merge m:1 seasch NCESDistrictID using "${NCES}/NCES_2015_School_AZ.dta", force
drop if _merge == 2
drop _merge
...
merge m:1 State_leaid using "${NCES}/NCES_2015_District_AZ.dta"
drop if _merge == 2
drop _merge
