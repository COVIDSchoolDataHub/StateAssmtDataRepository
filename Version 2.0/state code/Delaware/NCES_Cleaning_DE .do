...
gen StateAssignedDistID = substr(State_leaid, strpos(State_leaid, "-")+1, .)
	...
	keep State StateAbbrev StateFips NCESDistrictID StateAssignedDistID DistType CountyName CountyCode DistLocale DistCharter DistName
...
drop if StateAssignedSchID==""
	...
	keep State StateAbbrev StateFips NCESDistrictID NCESSchoolID State_leaid StateAssignedSchID DistType CountyName CountyCode DistLocale DistCharter SchName SchType SchVirtual SchLevel seasch DistName
	drop if seasch == ""
