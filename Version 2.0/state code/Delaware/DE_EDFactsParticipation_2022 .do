...
foreach s in ela math sci {
	import delimited "${EDFacts}/DE_EFParticipation_2022_`s'.csv", case(preserve) clear
	save "${EDFacts}/DE_EFParticipation_2022_`s'.dta", replace
}

use "${EDFacts}/DE_EFParticipation_2022_ela.dta"
append using "${EDFacts}/DE_EFParticipation_2022_math.dta" "${EDFacts}/DE_EFParticipation_2022_sci.dta"
...
save "${EDFacts}/DE_EFParticipation_2022", replace

//Merging with 2022
use "${State_Output}/DE_AssmtData_2022", clear
