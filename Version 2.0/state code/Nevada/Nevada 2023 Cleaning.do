...
use "${raw}/ELA & Math/Grade 3 2023.dta", clear
gen GradeLevel = "G03"

foreach a of numlist 4/8 {
	append using "${raw}/ELA & Math/Grade `a' 2023.dta"
	replace GradeLevel = "G0`a'" if GradeLevel == ""
}

append using "${raw}/Sci/Grade 5 2023.dta"
replace GradeLevel = "G05" if GradeLevel == ""
append using "${raw}/Sci/Grade 8 2023.dta"
