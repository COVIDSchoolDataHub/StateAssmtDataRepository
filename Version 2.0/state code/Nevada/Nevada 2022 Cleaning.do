...
foreach a of numlist 4/8 {
	append using "${raw}/ELA & Math/Grade `a' 2022.dta"
	replace GradeLevel = "G0`a'" if GradeLevel == ""
}

append using "${raw}/Sci/Grade 5 2022.dta"
replace GradeLevel = "G05" if GradeLevel == ""
append using "${raw}/Sci/Grade 8 2022.dta"
...
export delimited using "${output}/csv/NV_AssmtData_2022.csv", replace
