...
use "$raw/OH_OriginalData_2021.dta", clear
...
save "$NCES_clean/NCES_2020_District_OH.dta", replace
...
save "$NCES_clean/NCES_2020_School_OH.dta", replace

* Merge Data
use "$output/OH_AssmtData_2021.dta", clear

merge m:1 StateAssignedDistID using "$NCES_clean/NCES_2020_District_OH.dta"
drop if _merge == 2
drop _merge

merge m:1 StateAssignedSchID using "$NCES_clean/NCES_2020_School_OH.dta"
