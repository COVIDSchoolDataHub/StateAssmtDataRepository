...
/*
import delimited "$Original/AL_OriginalData_2023_ela.csv", clear
save "$Original/AL_OriginalData_2023_ela.dta", replace
import delimited "$Original/AL_OriginalData_2023_mat.csv", clear
save "$Original/AL_OriginalData_2023_mat.dta", replace
import delimited "$Original/AL_OriginalData_2023_sci.csv", clear
save "$Original/AL_OriginalData_2023_sci.dta", replace

append using "$Original/AL_OriginalData_2023_ela.dta" "$Original/AL_OriginalData_2023_mat.dta"

save "$Original/AL_OriginalData_2023.dta", replace

foreach Subject in ela math sci {
	import excel "${Original}/AL_OriginalData`Subject'_2023", firstrow case(preserve) clear
	save "${Original}/AL_OriginalData`Subject'_2023_codes", replace
	clear
}
use "${Original}/AL_OriginalDataela_2023_codes"
append using "${Original}/AL_OriginalDatamath_2023_codes" "${Original}/AL_OriginalDatasci_2023_codes"
...
drop tag
save "${Original}/AL_OriginalData_2023_codes", replace
clear
*/

use "${Original}/AL_OriginalData_2023", clear
...
merge m:1 DistName SchName using "${Original}/AL_OriginalData_2023_codes"
drop if _merge == 2
drop _merge
...
save "${Output}/AL_AssmtData_2023", replace
export delimited "${Output}/AL_AssmtData_2023", replace
