...
forvalues i = 3/8 {
	...
	*drop *lepf*
	...
	save "$temp_files/TX_Temp_2022_G0`i'_State.dta", replace
}
...
save "$temp_files/TX_Temp_2022_All_State.dta", replace
...
forvalues i = 3/8 {
	...
	*drop *lepf*
	...
	save "$temp_files/TX_Temp_2022_G0`i'_District.dta", replace
}

clear
append using "$temp_files/TX_Temp_2022_G03_District.dta" "$temp_files/TX_Temp_2022_G04_District.dta" "$temp_files/TX_Temp_2022_G05_District.dta" "$temp_files/TX_Temp_2022_G06_District.dta" "$temp_files/TX_Temp_2022_G07_District.dta" "$temp_files/TX_Temp_2022_G08_District.dta"

generate CAMPUS = ""
generate CNAME = "All Schools"
generate DataLevel = "District"

save "$temp_files/TX_Temp_2022_All_District.dta", replace
...
forvalues i = 3/8 {
	...
	*drop *lepf*
	...
	save "$temp_files/TX_Temp_2022_G0`i'_School.dta", replace
}

clear
append using "$temp_files/TX_Temp_2022_G03_School.dta" "$temp_files/TX_Temp_2022_G04_School.dta" "$temp_files/TX_Temp_2022_G05_School.dta" "$temp_files/TX_Temp_2022_G06_School.dta" "$temp_files/TX_Temp_2022_G07_School.dta" "$temp_files/TX_Temp_2022_G08_School.dta"

generate DataLevel = "School"

save "$temp_files/TX_Temp_2022_All_School.dta", replace

// Combine Data Levels

clear 
append using "$temp_files/TX_Temp_2022_All_State.dta" "$temp_files/TX_Temp_2022_All_District.dta" "$temp_files/TX_Temp_2022_All_School.dta"

save "$temp_files/TX_Temp_2022_All_All.dta", replace

*/

// Splitting Subject and Subgroups

use "$temp_files/TX_Temp_2022_All_All.dta", clear
...
merge 1:m state_leaid using "${output_files}/TX_AssmtData_2022.dta", keep(match using) nogenerate
...
merge 1:m seasch using "${output_files}/TX_AssmtData_2022.dta", keep(match using) nogenerate
