...
// Removing participation rate data from EDFacts for 2023 and 2024
replace ParticipationRate = "--" if SchYear == "2022-23"
replace ParticipationRate = "--" if SchYear == "2023-24"
