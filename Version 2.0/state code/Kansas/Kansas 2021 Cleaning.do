...
merge m:1 State_leaid using "${NCES}/NCES_2020_District_KS.dta"
...
merge m:1 seasch using "${NCES}/NCES_2020_School_KS.dta"
...
save "${raw}/KS_AssmtData_2021_Gender.dta", replace
restore

append using "${raw}/KS_AssmtData_2021_Gender.dta"
...
export delimited using "${output}/KS_AssmtData_2021.csv", replace
