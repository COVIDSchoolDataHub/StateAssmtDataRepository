...
merge m:1 State_leaid using "${NCES}/NCES_2017_District_KS.dta"
...
merge m:1 seasch using "${NCES}/NCES_2017_School_KS.dta"
...
replace StudentGroup_TotalTested = AllStudents_Tested if inlist(StudentGroup, "Homeless Enrolled Status", "Migrant Status")
