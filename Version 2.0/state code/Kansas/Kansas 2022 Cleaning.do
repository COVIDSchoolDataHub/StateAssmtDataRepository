...
use "${raw}/KS_AssmtData_2022.dta", clear
...
merge m:1 State_leaid using "${NCES}/NCES_2021_District_KS.dta"
...
merge m:1 seasch using "${NCES}/NCES_2021_School_KS.dta"
...
save "${output}/KS_AssmtData_2022.dta", replace

export delimited using "${output}/KS_AssmtData_2022.csv", replace
