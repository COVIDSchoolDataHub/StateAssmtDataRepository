...
global EDFacts "/Users/kaitlynlucas/Desktop/EDFacts Drive Data/KY_2022" //Folder with downloaded state-specific 2022 participation data from EDFacts
global State_Output "/Users/kaitlynlucas/Desktop/EDFacts Drive Data/Kentucky Assessment" //Folder with state-specific data
global Output_20 "/Users/kaitlynlucas/Desktop/EDFacts Drive Data/Kentucky V2.0" //Folder for Output 2.0


foreach s in ela math sci {
	import delimited "${EDFacts}/KY_EFParticipation_2022_`s'.csv", case(preserve) clear
	save "${EDFacts}/KY_EFParticipation_2022_`s'.dta", replace
}

use "${EDFacts}/KY_EFParticipation_2022_ela.dta"
append using "${EDFacts}/KY_EFParticipation_2022_math.dta" "${EDFacts}/KY_EFParticipation_2022_sci.dta"
...
save "${EDFacts}/KY_EFParticipation_2022", replace

//Merging with 2022
use "${State_Output}/KY_AssmtData_2022", clear
...
//Merging
merge 1:1 NCESDistrictID NCESSchoolID GradeLevel Subject StudentSubGroup using "${EDFacts}/KY_EFParticipation_2022"
drop if _merge ==2
...
save "${Output_20}/KY_AssmtData_2022", replace
export delimited "${Output_20}/KY_AssmtData_2022", replace
