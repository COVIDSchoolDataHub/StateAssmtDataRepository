...
foreach s in ela math sci {
	...
	save "${EDFacts}/AR_EFParticipation_2022_`s'.dta", replace
}

use "${EDFacts}/AR_EFParticipation_2022_ela.dta"
append using "${EDFacts}/AR_EFParticipation_2022_math.dta" "${EDFacts}/AR_EFParticipation_2022_sci.dta"
