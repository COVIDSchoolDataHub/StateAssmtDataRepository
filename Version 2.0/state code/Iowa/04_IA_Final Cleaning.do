...
// 2004 to 2014
global years 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 2014 
...
*export delimited "${int}/intermediate2/IA_AssmtData_`a'_temp.csv", replace
}


// 2015 to 2023
global years 2015 2016 2017 2018 2019 2021 2022 2023 // 2020
...
global years 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2021 2022 2023 // 2020

foreach a in $years {
    
	use "${int}/intermediate2/IA_AssmtData_`a'_temp.dta", clear
...
save "${int}/intermediate2/IA_AssmtData_`a'_temp.dta", replace
*export int "${output}/intermediate2/IA_AssmtData_`a'_temp.csv", replace
}
...
{
global years 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2021 2022 2023 2024 // 2020
...
export delimited "${output}/IA_AssmtData_`a'.csv", replace
	}


// 2023 update for Ruby Van Meter 
clear 
import delimited "${output}/IA_AssmtData_2023.csv", case(preserve)
