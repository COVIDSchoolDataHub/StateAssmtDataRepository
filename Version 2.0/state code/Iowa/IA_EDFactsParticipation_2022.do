...
foreach s in ela math sci {
	import delimited "${Original}/IA_EFParticipation_2022_`s'.csv", case(preserve) clear
	save "${Original}/IA_EFParticipation_2022_`s'.dta", replace
}



use "${Original}/IA_EFParticipation_2022_ela.dta"
append using "${Original}/IA_EFParticipation_2022_math.dta" "${Original}/IA_EFParticipation_2022_sci.dta"
...
save "${Original}/IA_EFParticipation_2022", replace

//Merging with 2022
import delimited "${Output_11}/IA_AssmtData_2022", case(preserve) clear
save "${Output_11}/IA_AssmtData_2022", replace

use "${Output_11}/IA_AssmtData_2022", clear
...
//Merging
merge 1:1 NCESDistrictID NCESSchoolID GradeLevel Subject StudentSubGroup using "${Original}/IA_EFParticipation_2022"
drop if _merge ==2
...
save "${Output_20}/IA_AssmtData_2022", replace
export delimited "${Output_20}/IA_AssmtData_2022", replace
