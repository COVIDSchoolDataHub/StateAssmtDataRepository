...
tempfile temp1
save "`temp1'", emptyok
import delimited "${Original}/MD_OriginalData_2015_ela_mat.csv", case(preserve) clear
...
drop TestType
drop if strpos(Assessment, "Grade 10") !=0 | strpos(Assessment, "Algebra") !=0
...
tab SchName if ProficientOrAbove_count == ""
