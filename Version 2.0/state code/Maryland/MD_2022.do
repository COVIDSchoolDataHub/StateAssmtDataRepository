...
merge m:1 State_leaid using "${NCES_MD}/NCES_2021_District", keep(match master) nogen
merge m:1 seasch using "${NCES_MD}/NCES_2021_School", keep(match master) nogen
...
export delimited "${Output}/MD_AssmtData_2022.csv", replace
