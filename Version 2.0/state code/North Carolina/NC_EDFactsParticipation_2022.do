...
foreach s in ela math sci {
	import delimited "${Original}/NC_EFParticipation_2022_`s'.csv", case(preserve) clear
	save "${Original}/NC_EFParticipation_2022_`s'.dta", replace
}



use "${Original}/NC_EFParticipation_2022_ela.dta"
append using "${Original}/NC_EFParticipation_2022_math.dta" "${Original}/NC_EFParticipation_2022_sci.dta"
...
save "${Original}/NC_EFParticipation_2022", replace

//Merging with 2022
import delimited "${Output_11}/NC_AssmtData_2022", case(preserve) clear
save "${Output_11}/NC_AssmtData_2022", replace

use "${Output_11}/NC_AssmtData_2022", clear
...
//Merging
merge 1:1 NCESDistrictID NCESSchoolID GradeLevel Subject StudentSubGroup using "${Original}/NC_EFParticipation_2022"
drop if _merge ==2
...
save "${Output_20}/NC_AssmtData_2022", replace
export delimited "${Output_20}/NC_AssmtData_2022", replace
