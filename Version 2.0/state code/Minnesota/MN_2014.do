...
import delimited "$original_files/MN_OriginalData_2014_mat.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${temp_files}/MN_AssmtData_2014_mat.dta", replace

import delimited "$original_files/MN_OriginalData_2014_rea.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${temp_files}/MN_AssmtData_2014_rea.dta", replace

import delimited "$original_files/MN_OriginalData_2014_sci.tab", clear
drop schoolcountynumber
drop districtcountynumber
...
save "${temp_files}/MN_AssmtData_2014_sci.dta", replace

clear

append using "${temp_files}/MN_AssmtData_2014_mat.dta" "${temp_files}/MN_AssmtData_2014_rea.dta" "${temp_files}/MN_AssmtData_2014_sci.dta"
...
replace SchYear = "2013-14" if SchYear == "13-14"
...
local dropping "230004 240001 240002 240008 240010 847059 847659 847660 847661 847662 847663 847665 847667 847668 847669 847670 847671"
...
save "${output_files}/MN_AssmtData_2014.dta", replace
...
merge 1:m seasch using "${output_files}/MN_AssmtData_2014.dta", keep(match using) nogenerate

save "${output_files}/MN_AssmtData_2014.dta", replace

// Merging with NCES District Data

use "$NCES_files/NCES_2013_District.dta", clear 
...
merge 1:m state_leaid using "${output_files}/MN_AssmtData_2014.dta", keep(match using) nogenerate
...
save "${output_files}/MN_AssmtData_2014.dta", replace
export delimited using "$output_files/MN_AssmtData_2014.csv", replace
