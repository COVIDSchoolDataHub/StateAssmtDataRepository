...
import delimited "$original_files/MN_OriginalData_2016_mat.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${temp_files}/MN_AssmtData_2016_mat.dta", replace

import delimited "$original_files/MN_OriginalData_2016_rea.tab", clear
tostring grade, replace
replace grade = "0" + grade
drop schoolcountynumber
drop districtcountynumber
save "${temp_files}/MN_AssmtData_2016_rea.dta", replace

import delimited "$original_files/MN_OriginalData_2016_sci.tab", clear
drop schoolcountynumber
drop districtcountynumber
...
save "${output_files}/MN_AssmtData_2016.dta", replace
...
merge 1:m seasch using "${output_files}/MN_AssmtData_2016.dta", keep(match using) nogenerate
...
merge 1:m state_leaid using "${output_files}/MN_AssmtData_2016.dta", keep(match using) nogenerate
...
save "${output_files}/MN_AssmtData_2016.dta", replace
export delimited using "$output_files/MN_AssmtData_2016.csv", replace
