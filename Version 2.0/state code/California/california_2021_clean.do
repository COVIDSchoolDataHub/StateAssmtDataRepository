...
// 2020-21 School Year 
use "$data/California_Original_2021", clear
...
merge m:1 NCESDistrictID using "$nces/NCES_2020_District.dta", gen(DistMerge1)
...
merge m:1 NCESSchoolID using "${nces}/NCES_2020_School.dta", gen(SchMerge1)
...
//ParticipationRate
gen ParticipationRate = string(real(StudentSubGroup_TotalTested)/real(StudentsEnrolled), "%9.3g")
...
save "${output}/CA_AssmtData_2021_ela_math", replace
