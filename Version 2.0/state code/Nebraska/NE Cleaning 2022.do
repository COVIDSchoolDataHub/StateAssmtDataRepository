...
save "$data/NE_AssmtData_2022.dta", replace

import delimited "$data/NE_OriginalData_2022_mat.csv", clear
save "$data/NE_AssmtData_2022_math.dta", replace

import delimited "$data/NE_OriginalData_2022_sci.csv", clear
save "$data/NE_AssmtData_2022_sci.dta", replace

use "$data/NE_AssmtData_2022.dta", clear
append using "$data/NE_AssmtData_2022_math.dta" "$data/NE_AssmtData_2022_sci.dta"
...
merge m:1 seasch state_leaid using "$NCES/NCES_2021_School.dta", gen (merge2)
drop if merge2 == 2
save "$data/NE_AssmtData_2022.dta", replace
...
save "$output/NE_AssmtData_2022.dta", replace
export delimited "$output/NE_AssmtData_2022", replace
clear
