...
save "${output}/VA_2011_base.dta", replace


////	Import disaggregate gender data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2011_all_gender.csv", varnames(1) clear 

rename gender StudentSubGroup
gen StudentGroup = "Gender"

save "${output}/VA_2011_gender.dta", replace


////	Import disaggregate language proficiency data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2011_all_language.csv", varnames(1) clear 

rename englishlearners StudentSubGroup
gen StudentGroup = "EL Status"

save "${output}/VA_2011_language.dta", replace


////	Import disaggregate race data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2011_all_race.csv", varnames(1) clear 

rename race StudentSubGroup
gen StudentGroup = "RaceEth"

save "${output}/VA_2011_race.dta", replace


//// Import disaggregate economic status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2011_all_econ.csv", varnames(1) clear
...
save "${output}/VA_2011_econ.dta", replace


//// Import disaggregate migrant status data

import delimited "/${raw}/Disaggregate/VA_OriginalData_2011_all_migrant.csv", varnames(1) clear
...
save "${output}/VA_2011_migrant.dta", replace


////	Append aggregate and disaggregate 

use "${output}/VA_2011_base.dta", clear

append using "${output}/VA_2011_gender.dta"
append using "${output}/VA_2011_language.dta"
append using "${output}/VA_2011_race.dta"
append using "${output}/VA_2011_econ.dta"
append using "${output}/VA_2011_migrant.dta"
...
merge m:1 seasch using "/${NCES}/NCES_2010_School.dta"
drop if _merge == 2
drop _merge
...
save "${output}/VA_AssmtData_2011.dta", replace

export delimited using "${output}/csv/VA_AssmtData_2011.csv", replace
