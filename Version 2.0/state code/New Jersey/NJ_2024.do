...
local year 2024
	//Import Excel Files and Convert to .dta Files
		forvalues n = 3/8{
			if `n' == 3{
				import excel "${data}/NJ_OriginalData_`year'_ela_G0`n'", cellrange (A3:Q26266) clear
			}
			else if `n' == 4{
				import excel "${data}/NJ_OriginalData_`year'_ela_G0`n'", cellrange (A3:Q25702) clear
			}
			else if `n' == 5{
				import excel "${data}/NJ_OriginalData_`year'_ela_G0`n'", cellrange (A3:Q24326) clear
			}
			else if `n' == 6{
				import excel "${data}/NJ_OriginalData_`year'_ela_G0`n'", cellrange (A3:Q17448) clear
			}
			else if `n' == 7{
				import excel "${data}/NJ_OriginalData_`year'_ela_G0`n'", cellrange (A3:Q17702) clear
			}
			else if `n' == 8{
				import excel "${data}/NJ_OriginalData_`year'_ela_G0`n'", cellrange (A3:Q17482) clear
			}
			else{
			...
			if `n' == 4 {
				import excel "${data}/NJ_OriginalData_`year'_math_G0`n'", cellrange (A1:Q25779) clear
			}
			else {
				import excel "${data}/NJ_OriginalData_`year'_math_G0`n'", clear
			}
			gen Subject = "math"
			...
			rename P Lev4_percent
			rename Q Lev5_percent
			save "${data}/NJ_OriginalData_`year'_math_G0`n'", replace
	...
	append using "${data}/NJ_OriginalData_`year'_math_G03" "${data}/NJ_OriginalData_`year'_math_G04" "${data}/NJ_OriginalData_`year'_math_G05" "${data}/NJ_OriginalData_`year'_math_G06" "${data}/NJ_OriginalData_`year'_math_G07" "${data}/NJ_OriginalData_`year'_math_G08"
...
//Fixing Counts and Percents
	...
	save "${data}/NJ_OriginalData_`year'", replace
		...
		save "${NCES}/NCES_2024_School_NJ.dta", replace
	...
	merge m:1 StateAssignedSchID StateAssignedDistID using "${NCES}/NCES_2024_School_NJ.dta", gen (merge2)
	drop if merge2 == 2
