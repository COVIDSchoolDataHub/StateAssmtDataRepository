...
foreach s in ela math sci {
	import delimited "${Original}/PA_EFParticipation_2022_`s'.csv", case(preserve) clear
	save "${Original}/PA_EFParticipation_2022_`s'.dta", replace
}



use "${Original}/PA_EFParticipation_2022_ela.dta"
...
save "${Original}/PA_EFParticipation_2022", replace

//Merging with 2022
import delimited "${Output_11}/PA_AssmtData_2022", case(preserve) clear
save "${Output_11}/PA_AssmtData_2022", replace

use "${Output_11}/PA_AssmtData_2022", clear
...
//Merging
merge 1:1 NCESDistrictID NCESSchoolID GradeLevel Subject StudentSubGroup using "${Original}/PA_EFParticipation_2022"
drop if _merge ==2
...
save "${Output_20}/PA_AssmtData_2022", replace
export delimited "${Output_20}/PA_AssmtData_2022", replace
