...
// 2020-2021
/*
import excel "$original_files/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2021_state.dta", replace

import excel "$original_files/2020-2021 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
