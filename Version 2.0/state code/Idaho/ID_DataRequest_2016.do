...
// 2015-2016
/*
import excel "$original_files/2015-2016 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2016_state.dta", replace

import excel "$original_files/2015-2016 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
gen DataLevel = "District"
save "${temp_files}/ID_AssmtData_2016_district.dta", replace

import excel "$original_files/2015-2016 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
...
use "${temp_files}/ID_AssmtData_2016_all.dta", clear
...
// Fixing Pocatello Community Charter
