...
// 2017-2018
/*
import excel "$original_files/2017-2018 Assessment Aggregates (Redacted).xlsx", sheet("State Of Idaho") firstrow clear
gen DataLevel = "State"
save "${temp_files}/ID_AssmtData_2018_state.dta", replace

import excel "$original_files/2017-2018 Assessment Aggregates (Redacted).xlsx", sheet("Districts") firstrow clear
gen DataLevel = "District"
save "${temp_files}/ID_AssmtData_2018_district.dta", replace

import excel "$original_files/2017-2018 Assessment Aggregates (Redacted).xlsx", sheet("Schools") firstrow clear
